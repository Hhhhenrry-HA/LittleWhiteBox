...
export const ADMINISTRATOR_COPY = Object.freeze({
    ...
    latest: '回到最新', earlier: '更早记录', later: '后面记录', retry: '重试', recheck: '重新核查', confirm: '重新提交', check: '检查保存结果', close: '关闭',
    empty: '有什么需要处理？', details: '查看过程', moreText: '后续内容', previousText: '前段内容',
    evidence: '查看资料', itemReport: (applied: number, skipped: number) => `成功 ${applied} 项，未完成 ${skipped} 项`,
    messageActions: '消息操作', messagePages: '消息分页', noReply: '尚未回复', longReply: '完整回复将在结束后分页显示。',
    adopt: '放弃未保存内容',
    ...
    phases: { preparing: '准备中', replying: '回复中', summarizing: '整理上下文', saving: '保存中' },
