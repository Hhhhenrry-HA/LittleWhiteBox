/* eslint-disable */
import { A as Z, D as P, M as j, Q as L, S as g, _ as F, a as f, c as y, et as o, f as S, k as G, l as i, m as H, o as t, p as I, r as _, s as A, x as n, y as J } from "./xiaobai-os-runtime-core.esm-bundler-Dmqi2Zbl.js";
import { a as W, c as R, s as X } from "./xiaobai-os-runtime-dom.esm-bundler-BYy7nd4d.js";
var Y = {
  ...
  setup(r) {
    ...
    }), p = f(() => l[c.name] || l.auto_awesome);
    return (v, T) => (n(), i("svg", Y, [t("path", { d: p.value }, null, 8, t1)]));
  }
}), C = e1, a1 = ["aria-labelledby"], l1 = ["id"], s1 = { class: "shop-dialog-item" }, q1 = [
  "onUpdate:modelValue",
  "maxlength",
  "placeholder"
], n1 = {
  ...
  role: "alert"
}, o1 = { class: "shop-dialog-actions" }, i1 = ["disabled"], r1 = ["disabled"], u1 = /* @__PURE__ */ H({
  ...
  setup(r, { emit: c }) {
    const l = r, p = c, v = G({}), T = f(() => l.mode === "purchase" ? "确认购入" : l.mode === "deactivate" ? "关闭效果" : "确认使用"), m = f(() => l.mode === "purchase" ? `将支付 ${l.item.price} 小白币，奇物会先放入背包。` : l.mode === "deactivate" ? "关闭后将从下一次回复起停止影响剧情，已经发生的事实不会消失。" : l.item.duration === "permanent" ? "这件奇物将永久影响后续剧情，使用后无法关闭。" : `使用后从下一次回复起${l.item.durationLabel}。`), u = f(() => l.mode !== "use" || l.item.inputs.every((s) => String(v[s.key] || "").trim().length > 0));
    function q() {
      !l.busy && u.value && p("confirm", { ...v });
    }
    return (s, e) => (n(), i("dialog", {
      open: "",
      class: "shop-dialog",
      "aria-labelledby": `shop-dialog-${r.mode}`,
      onClick: e[1] || (e[1] = R((b) => !r.busy && s.$emit("cancel"), ["self"])),
      onKeydown: e[2] || (e[2] = X(R((b) => !r.busy && s.$emit("cancel"), ["stop", "prevent"]), ["esc"]))
    }, [t("form", {
      method: "dialog",
      class: "shop-dialog-card",
      onSubmit: R(q, ["prevent"])
    }, [
      t("h2", { id: `shop-dialog-${r.mode}` }, o(T.value), 9, l1),
      t("div", s1, [t("span", null, [I(C, { name: r.item.icon }, null, 8, ["name"])]), t("div", null, [t("strong", null, o(r.item.name), 1), t("small", null, o(r.item.durationLabel), 1)])]),
      (n(!0), i(_, null, g(r.mode === "use" ? r.item.inputs : [], (b) => (n(), i("label", {
        key: b.key,
        class: "shop-dialog-field"
      }, [t("span", null, o(b.label), 1), P(t("input", {
        "onUpdate:modelValue": (k) => v[b.key] = k,
        type: "text",
        maxlength: b.maxLength,
        placeholder: b.placeholder,
        autocomplete: "off",
        required: ""
      }, null, 8, q1), [[W, v[b.key]]])]))), 128)),
      t("p", { class: L(["shop-dialog-warning", { "is-permanent": r.mode === "use" && r.item.duration === "permanent" }]) }, o(m.value), 3),
      r.error ? (n(), i("p", n1, o(r.error), 1)) : y("", !0),
      t("div", o1, [t("button", {
        type: "button",
        disabled: r.busy,
        onClick: e[0] || (e[0] = (b) => s.$emit("cancel"))
      }, "再想想", 8, i1), t("button", {
        type: "submit",
        class: "is-primary",
        disabled: r.busy || !u.value
      }, o(r.busy ? "正在封存…" : r.mode === "purchase" ? "确认支付" : r.mode === "deactivate" ? "确认关闭" : "确认使用"), 9, r1)])
    ], 32)], 40, a1));
  }
}), v1 = u1, d1 = {
  class: "shop-inventory",
  "aria-labelledby": "shop-inventory-title"
}, T1 = { class: "shop-section-heading" }, c1 = {
  key: 0,
  ...
  setup(r) {
    const c = r, l = Z(!1), p = f(() => c.activations.filter((u) => u.state === "active")), v = f(() => c.catalog.filter((u) => u.quantity > 0)), T = f(() => c.catalog.filter((u) => u.purchasedCount > 0 && u.quantity === 0)), m = f(() => {
      const u = /* @__PURE__ */ new Map();
      for (const q of c.activations) q.state !== "active" && u.set(q.itemId, (u.get(q.itemId) || 0) + 1);
      return u;
    });
    return (u, q) => (n(), i("section", d1, [
      t("header", T1, [q[1] || (q[1] = t("h2", { id: "shop-inventory-title" }, "我的奇物", -1)), t("small", null, o(v.value.reduce((s, e) => s + e.quantity, 0)) + " 件可用", 1)]),
      r.writeDisabledReason ? (n(), i("p", c1, o(r.writeDisabledReason), 1)) : y("", !0),
      t("section", h1, [t("header", null, [q[2] || (q[2] = t("h3", { id: "shop-active-title" }, "生效中", -1)), t("span", null, o(p.value.length), 1)]), p.value.length ? (n(), i("div", p1, [(n(!0), i(_, null, g(p.value, (s) => (n(), i("article", {
        key: s.activationId,
        class: "shop-activation-card"
      }, [
        t("div", m1, [I(C, { name: s.icon }, null, 8, ["name"])]),
        t("div", null, [
          t("h4", null, o(s.name), 1),
          (n(!0), i(_, null, g(s.parameters, (e) => (n(), i("p", { key: e.label }, [t("span", null, o(e.label), 1), S(o(e.value), 1)]))), 128)),
          t("small", null, o(s.stateLabel), 1)
        ]),
        s.canDeactivate ? (n(), i("button", {
          key: 0,
          type: "button",
          disabled: !!r.writeDisabledReason,
          title: r.writeDisabledReason,
          onClick: (e) => u.$emit("deactivate", s)
        }, " 关闭 ", 8, f1)) : y("", !0)
      ]))), 128))])) : (n(), i("p", b1, "尚无正在影响剧情的奇物。"))]),
      t("section", y1, [t("header", null, [q[3] || (q[3] = t("h3", { id: "shop-held-title" }, "持有", -1)), t("span", null, o(v.value.length), 1)]), v.value.length ? (n(), i("div", Z1, [(n(!0), i(_, null, g(v.value, (s) => (n(), i("article", {
        key: s.id,
        class: "shop-held-card"
      }, [
        t("div", g1, [I(C, { name: s.icon }, null, 8, ["name"])]),
        t("div", null, [t("h4", null, o(s.name), 1), t("p", null, o(s.durationLabel), 1)]),
        t("strong", null, "×" + o(s.quantity), 1),
        t("button", {
          type: "button",
          disabled: !!r.writeDisabledReason,
          title: r.writeDisabledReason,
          onClick: (e) => u.$emit("use", s)
        }, " 使用 ", 8, _1)
      ]))), 128))])) : (n(), i("p", M1, "背包还是空的，去货架挑一件吧。"))]),
      T.value.length ? (n(), i("section", k1, [t("button", {
        type: "button",
        class: "shop-collapse-button",
        "aria-expanded": l.value,
        onClick: q[0] || (q[0] = (s) => l.value = !l.value)
      }, [
        q[4] || (q[4] = t("span", null, "已耗尽", -1)),
        t("small", null, o(T.value.length), 1),
        q[5] || (q[5] = t("i", { "aria-hidden": "true" }, "⌄", -1))
      ], 8, $1), l.value ? (n(), i("div", L1, [(n(!0), i(_, null, g(T.value, (s) => (n(), i("article", { key: s.id }, [t("span", null, o(s.name), 1), t("small", null, [S("购入 " + o(s.purchasedCount) + " 次", 1), m.value.get(s.id) ? (n(), i("span", H1, " · 已结束 " + o(m.value.get(s.id)), 1)) : y("", !0)])]))), 128))])) : y("", !0)])) : y("", !0)
    ]));
  }
}), Q1 = w1, S1 = {
  class: "shop-shelf",
  "aria-labelledby": "shop-shelf-title"
}, I1 = { class: "shop-section-heading" }, C1 = {
  class: "shop-category-strip",
  "aria-label": "商品分类"
}, D1 = ["onClick"], x1 = { class: "shop-product-grid" }, A1 = { class: "shop-product-mark" }, R1 = { class: "shop-product-copy" }, B1 = { class: "shop-product-title" }, U1 = { class: "shop-product-footer" }, E1 = { key: 0 }, V1 = [
  "disabled",
  "title",
  "onClick"
], N1 = {
  ...
  emits: ["purchase"],
  setup(r) {
    const c = r, l = Z("all"), p = f(() => c.catalog.filter((q) => q.onShelf)), v = f(() => {
      const q = /* @__PURE__ */ new Map();
      for (const s of p.value) q.set(s.category, s.categoryLabel);
      return [{
        id: "all",
        label: "全部"
      }, ...Array.from(q, ([s, e]) => ({
    ...
    }), T = f(() => l.value === "all" ? p.value : p.value.filter((q) => q.category === l.value));
    function m(q) {
      return c.writeDisabledReason ? c.writeDisabledReason : u(q);
    }
    function u(q) {
      return q.purchaseLimit !== null && q.purchasedCount >= q.purchaseLimit ? "此奇物已达购买上限" : c.balance < q.price ? `还差 ${q.price - c.balance} 小白币` : "";
    }
    return (q, s) => (n(), i("section", S1, [
      t("header", I1, [s[0] || (s[0] = t("h2", { id: "shop-shelf-title" }, "今日陈列", -1)), t("small", null, o(T.value.length) + " 件奇物", 1)]),
      t("nav", C1, [(n(!0), i(_, null, g(v.value, (e) => (n(), i("button", {
        key: e.id,
        type: "button",
        class: L({ "is-active": l.value === e.id }),
        onClick: (b) => l.value = e.id
      }, o(e.label), 11, D1))), 128))]),
      t("div", x1, [(n(!0), i(_, null, g(T.value, (e) => (n(), i("article", {
        key: e.id,
        class: "shop-product-card"
      }, [t("div", A1, [I(C, { name: e.icon }, null, 8, ["name"])]), t("div", R1, [
        t("div", B1, [t("h3", null, o(e.name), 1), t("span", null, o(e.categoryLabel), 1)]),
        t("p", null, o(e.description), 1),
        t("small", null, o(e.durationLabel), 1),
        t("div", U1, [
          t("strong", null, [s[1] || (s[1] = t("i", null, "¤", -1)), S(o(e.price), 1)]),
          e.quantity ? (n(), i("span", E1, "持有 " + o(e.quantity), 1)) : y("", !0),
          t("button", {
            type: "button",
            disabled: !!m(e),
            title: m(e),
            onClick: (b) => q.$emit("purchase", e)
          }, o(e.purchaseLimit !== null && e.purchasedCount >= e.purchaseLimit ? "已购得" : "购入"), 9, V1)
        ]),
        u(e) ? (n(), i("p", N1, o(u(e)), 1)) : y("", !0)
      ])]))), 128))])
    ]));
  }
}), z1 = O1, K1 = { class: "shop-app" }, P1 = { class: "shop-header" }, j1 = {
  class: "shop-balance",
  "aria-label": "小白币余额"
}, F1 = ["disabled"], G1 = {
  class: "shop-root-tabs",
  "aria-label": "商店页面"
}, J1 = { key: 0 }, W1 = ["disabled"], X1 = ["disabled"], Y1 = { class: "shop-scroll" }, B = 35e3, t0 = /* @__PURE__ */ H({
  __name: "ShopApp",
  props: {
    bridge: {},
    initialState: {}
  ...
  setup(r) {
    const c = r, l = Z(structuredClone(j(c.initialState))), p = Z("shelf"), v = Z(null), T = Z(!1), m = Z(!1), u = Z(""), q = Z("");
    let s = () => {
    }, e = 0;
    const b = f(() => l.value.status === "unconfirmed"), k = f(() => m.value ? "正在处理上一项操作" : T.value ? "正在刷新商店状态" : l.value.status !== "ready" ? l.value.message || "商店暂时不可写入" : ""), U = f(() => k.value || (l.value.generationActive ? "主剧情正在生成，请等待回复完成" : "")), E = f(() => T.value || m.value || b.value);
    function N() {
    ...
    function w(d) {
      l.value = structuredClone(d), T.value = !1, u.value = "";
    }
    function Q(d) {
      const a = d instanceof Error ? d.message : String(d);
      return a.includes("cannot be overdrawn") ? "小白币余额不足，未完成购买。" : a.includes("shop_main_generation_active") ? "主剧情正在生成，请等待回复完成。" : a.includes("shop_revision_conflict") || a.includes("shop_event_id_conflict") ? "商店状态已变化，请关闭确认框后重试。" : a === "host_request_timeout" ? "等待保存结果超时，请使用同一确认框重试。" : "商店操作未完成，请稍后重试。";
    }
    async function V() {
      if (E.value) return;
      const d = ++e;
      T.value = !0, u.value = "";
      try {
        const a = await c.bridge.request("shop/refresh", D(), B);
        d === e && w(a.result);
      } catch (a) {
        d === e && (u.value = Q(a));
      } finally {
    ...
    async function O() {
      if (T.value || m.value) return;
      const d = ++e;
      T.value = !0, u.value = "";
      try {
        const a = await c.bridge.request("shop/confirm-save", D(), B);
        d === e && w(a.result.state);
      } catch (a) {
        d === e && (u.value = Q(a));
      } finally {
        d === e && (T.value = !1);
    ...
    function x(d, a, h) {
      (d === "purchase" ? k.value : U.value) || (q.value = "", v.value = {
        mode: d,
        item: a,
        activation: h,
        actionId: N()
    ...
    function z() {
      m.value || (v.value = null, q.value = "");
    }
    async function K(d) {
      const a = v.value;
      if (!a || m.value) return;
      m.value = !0, q.value = "";
      const h = e, M = a.mode === "purchase" ? "shop/purchase" : a.mode === "use" ? "shop/activate" : "shop/deactivate";
      try {
        const $ = await c.bridge.request(M, {
          ...D(),
          expectedRevision: l.value.revision,
          expectedEventId: l.value.eventId,
          actionId: a.actionId,
          itemId: a.item.id,
          ...a.mode === "use" ? { parameters: d } : {},
          ...a.activation ? { activationId: a.activation.activationId } : {}
        }, B);
        if (h !== e || v.value !== a) return;
        w($.result), v.value = null;
      } catch ($) {
        h === e && v.value === a && (q.value = Q($));
      } finally {
        h === e && (m.value = !1);
      }
    }
    return J(() => {
      s = c.bridge.subscribe((d) => {
        d.type === "shop/state" && (m.value || (e += 1), w(d.payload.state)), d.type === "shop/error" && (u.value = Q(d.payload?.message || ""));
      });
    }), F(() => {
      e += 1, s(), v.value = null;
    }), (d, a) => (n(), i("main", K1, [
      t("header", P1, [
        a[7] || (a[7] = t("div", null, [t("h1", null, "奇物商店")], -1)),
        t("div", j1, [a[5] || (a[5] = t("small", null, "余额", -1)), t("strong", null, "¤ " + o(l.value.balance), 1)]),
        t("button", {
          type: "button",
          class: "shop-refresh",
          disabled: E.value,
          ...
          viewBox: "0 0 24 24",
          "aria-hidden": "true"
        }, [t("path", { d: "M20 7v5h-5M4 17v-5h5M18.2 9A7 7 0 0 0 6.1 6.7L4 9m16 6-2.1 2.3A7 7 0 0 1 5.8 15" })], -1), t("span", { class: "shop-sr-only" }, "重新读取商店", -1)])], 8, F1)
      ]),
      t("nav", G1, [t("button", {
        type: "button",
        class: L({ "is-active": p.value === "shelf" }),
        onClick: a[0] || (a[0] = (h) => p.value = "shelf")
      }, "货架", 2), t("button", {
        type: "button",
        class: L({ "is-active": p.value === "inventory" }),
        onClick: a[1] || (a[1] = (h) => p.value = "inventory")
      }, [a[8] || (a[8] = S(" 背包", -1)), l.value.catalog.some((h) => h.quantity) ? (n(), i("span", J1, o(l.value.catalog.reduce((h, M) => h + M.quantity, 0)), 1)) : y("", !0)], 2)]),
      l.value.message || u.value ? (n(), i("aside", {
        key: 0,
        class: L(["shop-notice", `is-${l.value.status}`]),
        role: "status"
      }, [a[9] || (a[9] = t("span", { "aria-hidden": "true" }, "印", -1)), t("div", null, [
        t("strong", null, o(l.value.status === "unconfirmed" ? "保存待核实" : l.value.status === "conflict" ? "状态冲突" : "商店状态"), 1),
        t("p", null, o(u.value || l.value.message), 1),
        b.value ? (n(), i("button", {
          key: 0,
          type: "button",
          disabled: T.value,
          onClick: O
        }, o(T.value ? "正在核实…" : "核实保存结果"), 9, W1)) : l.value.status === "blocked" ? (n(), i("button", {
          key: 1,
          type: "button",
          disabled: T.value,
          onClick: V
        }, o(T.value ? "正在读取…" : "重新读取"), 9, X1)) : y("", !0)
      ])], 2)) : y("", !0),
      t("div", Y1, [p.value === "shelf" ? (n(), A(z1, {
        key: 0,
        catalog: l.value.catalog,
        balance: l.value.balance,
        "write-disabled-reason": k.value,
        onPurchase: a[2] || (a[2] = (h) => x("purchase", h))
      }, null, 8, [
        "catalog",
        "balance",
        ...
        key: 1,
        catalog: l.value.catalog,
        activations: l.value.activations,
        "write-disabled-reason": U.value,
        onUse: a[3] || (a[3] = (h) => x("use", h)),
        onDeactivate: a[4] || (a[4] = (h) => {
          const M = l.value.catalog.find(($) => $.id === h.itemId);
          M && x("deactivate", M, h);
        })
      }, null, 8, [
        "catalog",
