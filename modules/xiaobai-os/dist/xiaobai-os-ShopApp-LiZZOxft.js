/* eslint-disable */
import { B as f1, F as _, L as p1, M as N, O as b1, P as T1, R as L, S as n1, T as C, V as i, _ as I, a as J, b as y1, c as S, d as A, f as b, g as c, h as T, i as o1, l as $, m as H, p as s, s as s1, u as t, w as a, y as k1, z as X } from "./xiaobai-os-runtime-dom.esm-bundler-DmE9neiz.js";
  ...
  setup(e) {
    ...
    return (h, l) => (a(), s("svg", {
      ...
      t("g", {
        ...
        e.name === "medical_services" ? (a(), s("path", N1)) : e.name === "lab_research" ? (a(), s("path", z1)) : (a(), s("path", E1))
...
var vt = ["aria-label"], qt = { class: "shop-dialog-heading" }, ht = { class: "shop-eyebrow" }, ct = { class: "shop-dialog-item" }, mt = { key: 0 }, ft = { key: 1 }, pt = {
  ...
  setup(e, { emit: p }) {
    const o = e, q = p, r = _(null), d = T1({}), u = $(() => o.mode === "purchase" ? "把这份奇妙带回去" : o.mode === "use" ? "让奇物进入故事" : "关闭这份效果？"), h = $(() => o.mode !== "use" || o.item.inputs.every((y) => String(d[y.key] || "").trim().length > 0)), l = $(() => !o.busy && !o.disabledReason && h.value);
    ...
    return (y, Z) => (a(), s("dialog", {
      ...
      }, [t("span", null, [T(i(g.label), 1), t("small", null, "最多 " + i(g.maxLength) + " 字", 1)]), N(t("input", {
...
}, At = ["aria-label", "onClick"], Bt = ["data-category"], Nt = [
  "disabled",
  "aria-label",
  "onClick"
], zt = {
  ...
  setup(e) {
    ...
    return (d, u) => (a(), s("section", Ht, [
      ...
      o.value.length ? (a(), s("div", Vt, [(a(!0), s(S, null, C(o.value, (h) => (a(), s("article", {
        ...
        }, [c(D, { name: h.icon }, null, 8, ["name"])], 8, Bt),
        t("span", null, [
      ...
      }, [u[4] || (u[4] = T("使用", -1)), c(k, { name: "next" })], 8, Nt)])]))), 128))])) : (a(), s("div", zt, [
  ...
  setup(e) {
    ...
    return (q, r) => (a(), s("section", ge, [
      ...
      t("footer", Ve, [
        ...
        }, [T(i(e.item.quantity ? "再购入一件" : "购入这件奇物"), 1), c(k, { name: "bag" })], 8, Be)]),
        r[13] || (r[13] = t("small", null, "购买后放入背包，不会自动使用", -1))
      ])
    ]));
  }
}), ze = Ne, Ee = { class: "shop-app" }, Ue = { class: "shop-header" }, Pe = { class: "shop-brand" }, je = { class: "shop-balance" }, Oe = ["disabled"], Ge = {
  key: 0,
  ...
  setup(e) {
    ...
    let m = 0;
    const y = _(null), Z = _(!1), g = _(!1), M = _(""), B = _(""), Q = $(() => o.value.catalog.find((v) => v.id === y.value?.itemId)), Y = $(() => o.value.activations.find((v) => v.activationId === y.value?.activationId));
    let t1 = () => {
    }, x = 0;
    ...
    function P(v, n, w) {
      (v === "purchase" ? z.value : R.value) || (B.value = "", f.value = "", y.value = {
        mode: v,
        itemId: n.id,
    ...
    async function v1() {
      d.value = null, await k1(), r.value?.scrollTo(0, m);
    }
    function q1(v) {
    ...
    return n1(() => {
      ...
      ])) : (a(), s(S, { key: 1 }, [q.value === "shelf" ? N((a(), A(de, {
        key: 0,
        catalog: o.value.catalog,
        onOpen: a1
      }, null, 8, ["catalog"])), [[J, !u.value]]) : q.value === "inventory" ? N((a(), A(jt, {
        key: 1,
        catalog: o.value.catalog,
      ...
      }, null, 8, ["catalog", "write-disabled-reason"])), [[J, !u.value]]) : N((a(), A(ke, {
        key: 2,
