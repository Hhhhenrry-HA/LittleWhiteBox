/* eslint-disable */
import { A as ce, B as Q, C as Be, E as ae, F as Te, H as b, I as p, N as Z, T as t, V as ye, _ as M, a as Y, b as ue, c as J, d as e, f as ie, g as V, j as fe, l as q, m as l, p as h, s as be, u as U, v as N, w as oe, y as _ } from "./xiaobai-os-runtime-dom.esm-bundler-DwdCK5Jt.js";
var De = {
  viewBox: "0 0 24 24",
  fill: "none",
  stroke: "currentColor",
...
}), ee = Ue, Ve = { class: "messages-contacts" }, Pe = { class: "messages-home-header" }, Fe = { class: "messages-search" }, ze = {
  key: 0,
...
}, je = ["onClick"], Ke = { class: "messages-contact-copy" }, Ne = { class: "messages-contact-heading" }, Re = {
  key: 0,
  ...
  emits: ["select", "add"],
  setup(a) {
    const y = a, i = p(""), r = U(() => y.contacts.filter((g) => `${g.name} ${g.note}`.toLocaleLowerCase().includes(i.value.toLocaleLowerCase())));
    function n(g) {
      if (g === null) return "";
      const d = new Date(g);
    ...
    return (g, d) => (t(), l("section", Ve, [
      e("header", Pe, [e("div", null, [d[4] || (d[4] = e("span", { class: "messages-eyebrow" }, "你们的对话，留在这里", -1)), e("h1", null, [d[3] || (d[3] = V("信息", -1)), e("span", null, b(a.contacts.length || ""), 1)])]), e("button", {
        class: "messages-icon-button",
        "aria-label": "添加联系人",
        onClick: d[0] || (d[0] = (o) => g.$emit("add"))
      }, [M(x, { name: "plus" })])]),
      e("label", Fe, [M(x, { name: "search" }), Z(e("input", {
        "onUpdate:modelValue": d[1] || (d[1] = (o) => i.value = o),
        type: "search",
        placeholder: "搜索联系人",
        "aria-label": "搜索联系人"
      }, null, 512), [[Y, i.value]])]),
      a.contacts.length ? (t(), l("div", He, [r.value.length ? h("", !0) : (t(), l("p", Ge, "没有找到这个人。")), (t(!0), l(q, null, ae(r.value, (o) => (t(), l("button", {
        key: o.id,
        ...
        identity: o.id,
        name: o.name
      }, null, 8, ["identity", "name"]), e("span", Ke, [e("span", Ne, [e("strong", null, b(o.name), 1), e("time", null, b(n(o.lastAt)), 1)]), a.busyContactId === o.id ? (t(), l("span", Re, "正在等待回复…")) : a.drafts.get(o.id)?.text.trim() || a.drafts.get(o.id)?.image ? (t(), l("span", Ze, [d[9] || (d[9] = e("em", null, "草稿", -1)), V(" " + b(a.drafts.get(o.id)?.image ? "［图片］" : "") + b(a.drafts.get(o.id)?.text), 1)])) : (t(), l("span", Ye, b(o.preview), 1))])], 8, je))), 128))])) : (t(), l("div", ze, [
        ...
        }, [d[5] || (d[5] = V("选择联系人", -1)), M(x, { name: "plus" })])
      ])),
  ...
  setup(a) {
    const y = a, i = p(""), r = p(!1), n = p(""), g = p(""), d = p(!1), o = U(() => y.message.payload.type === "image" ? y.message.payload.attachment : void 0), S = U(() => o.value?.path || i.value), E = p(!1), I = p(null), k = U(() => [
      "playing",
      "loading",
      "generating",
      "queued"
    ...
    async function C($) {
      if (!r.value) {
        ...
        try {
          ...
          f && (i.value = v.data ?? "", E.value = !1, $ && !i.value && (n.value = "请开启画图后再试，画面描述已保留。"));
        } catch {
    ...
    return Be(() => {
      ...
      }, [M(x, { name: "image" }), e("span", null, b(r.value ? "正在生成图片…" : n.value ? "重新生成图片" : "生成图片"), 1)], 8, _e)) : (t(), l("div", ea, [
        M(x, { name: "image" }),
      ...
      }, [e("button", ta, [M(x, { name: "close" })]), S.value ? (t(), l("img", {
        key: 0,
        src: S.value,
        alt: a.message.payload.description || o.value?.name || "图片"
      }, null, 8, la)) : h("", !0)], 544)
...
var ga = {
  ...
  role: "status"
}, ka = { class: "messages-composer-line" }, wa = ["disabled"], $a = ["placeholder", "disabled"], ha = ["disabled"], Ia = /* @__PURE__ */ N({
  ...
  setup(a, { emit: y }) {
    const i = a, r = y, n = ce(a, "draft"), g = U({
      get: () => n.value.text,
      set: (w) => {
        n.value = {
          ...n.value,
    ...
    async function I(w) {
      ...
      if (C.value = "", !(!F || i.sending || o.value)) {
        ...
        try {
          ...
          E && (S.value = T instanceof Error ? T.message : "图片读取失败，请重新选择。");
        } finally {
          E && (o.value = !1);
        }
      }
  ...
  setup(a, { expose: y }) {
    const i = ce(a, "draft"), r = a, n = p(null);
    let g = !0, d = !1;
    function o() {
      const k = n.value;
    ...
    return y({ sent() {
      ...
      e("div", {
        ...
        a.page.messages.length ? h("", !0) : (t(), l("p", Ea, [
          V(b(a.loading ? "正在读取消息…" : `这是你和 ${a.contact.name} 的对话。`), 1),
          c[7] || (c[7] = e("br", null, null, -1)),
          a.loading ? h("", !0) : (t(), l(q, { key: 0 }, [V("从一句问候开始吧。")], 64))
        ])),
        (t(!0), l(q, null, ae(a.page.messages, (f, w) => (t(), l(q, { key: f.id }, [w === 0 || f.createdAt - a.page.messages[w - 1].createdAt > 3e5 ? (t(), l("time", xa, b(new Date(f.createdAt).toLocaleString(void 0, {
          month: "numeric",
          day: "numeric",
          hour: "2-digit",
          minute: "2-digit"
...
var Va = { class: "messages-app" }, Pa = {
  ...
  class: "messages-error",
  role: "alert"
}, Na = { class: "messages-search" }, Ra = { class: "messages-known-list" }, Za = ["disabled", "onClick"], Ya = { key: 0 }, Ja = {
  key: 0,
  class: "messages-subtle"
}, Wa = { class: "messages-manual" }, Xa = ["disabled"], Oa = ["disabled"], Qa = ["disabled"], _a = ["disabled"], es = ["disabled"], as = ["disabled"], ss = { class: "messages-manual" }, ts = ["disabled"], ls = ["disabled"], ns = /* @__PURE__ */ N({
  __name: "MessagesApp",
  props: {
    bridge: {},
    initialState: {}
  ...
  setup(a) {
    const y = a, i = p(y.initialState), r = p(""), n = p({
      ...
      hasMore: !1,
      retryMessageId: null
    }), g = p(!1), d = p(!1), o = p(""), S = p(null), E = p(null), I = p("add"), k = p(""), c = p(""), f = p(""), w = p(""), C = p(O()), F = p(O());
    let T = !0, $ = 0;
    const v = Te(/* @__PURE__ */ new Map()), B = U({
    ...
    let P = null;
    const L = U(() => i.value.contacts.find((u) => u.id === r.value)), pe = U(() => i.value.busy && i.value.busy.contactId !== r.value ? i.value.contacts.find((u) => u.id === i.value.busy?.contactId)?.name ?? "另一位联系人" : ""), W = U(() => i.value.pendingSave || [
      "unconfirmed",
      "conflict",
      "failed"
    ].includes(i.value.fileState)), D = U(() => d.value || !!i.value.busy || i.value.pendingSave || i.value.fileState !== "ready" || i.value.generationActive), re = U(() => i.value.knownPeople.filter((u) => !i.value.contacts.some((s) => s.name === u.name) && `${u.name} ${u.aliases.join(" ")}`.toLocaleLowerCase().includes(w.value.toLocaleLowerCase())));
    ...
    async function se(u = !1, s = !1) {
      ...
      try {
        ...
        const ge = R.messages.some((K) => n.value.messages.some((ne) => ne.id === K.id)), xe = !s && (u || ge) ? n.value.messages : [], le = [...new Map([...xe, ...R.messages].map((K) => [K.id, K])).values()].sort((K, ne) => K.seq - ne.seq);
        n.value = {
          ...R,
          messages: le,
          hasMore: s || u || !ge || le.length <= 50 ? R.hasMore : n.value.hasMore
        }, P?.contactId === m && le.some((K) => K.id === P?.messageId) && de();
      } catch {
    ...
    function H(u) {
      ...
      P && u.contacts.some((A) => A.lastMessageId === P?.messageId) && de(), r.value && !u.contacts.some((A) => A.id === r.value) ? te() : r.value && (s !== L.value?.lastSeq || m && !W.value) && se(!1, m && !W.value);
    }
    function de() {
      if (P) {
        const u = v.get(P.contactId);
        u && Ua(u, P.draft) && v.delete(P.contactId), P.contactId === r.value && S.value?.sent();
      }
      P = null, C.value = O();
    }
    ...
    function Ie() {
      j(async () => {
        H(await z("messages/sync")), G();
      });
    }
    async function X(u) {
      I.value = u, o.value = "", c.value = "", f.value = L.value?.note ?? "", w.value = "", F.value = O(), await ue(), E.value?.showModal();
    }
    function G() {
      E.value?.close();
    }
    function me(u = c.value) {
      !u.trim() || D.value || j(async () => {
        const s = await z("messages/contact/add", {
          actionId: F.value,
          name: u.trim(),
          note: f.value.trim()
        });
        H(s.state), G(), ve(s.contactId);
      });
    }
    function Me() {
      j(async () => {
    ...
    function Ce() {
      j(async () => {
        H(await z("messages/contact/delete", { contactId: r.value })), G(), te();
      });
    }
    function Se(u) {
    ...
    function Ae() {
      ...
      j(async () => {
        ...
        H(m.state), T && r.value === u && ($++, g.value = !1, n.value = {
          ...n.value,
    ...
    function Ee() {
      j(async () => {
        H(await z("messages/recover")), G();
      });
    }
    return oe(() => {
      T = !1, $++, ke();
    }), (u, s) => (t(), l("main", Va, [
      W.value ? (t(), l("div", Pa, [s[15] || (s[15] = e("span", null, "有消息还在等待保存确认，已保存的记录不会丢失。", -1)), e("button", {
      ...
      i.value.generationActive ? (t(), l("div", Ga, "故事正在继续，稍后就能发送消息。")) : h("", !0),
      o.value || i.value.error ? (t(), l("p", ja, b(o.value || i.value.error), 1)) : h("", !0),
      L.value ? (t(), ie(qa, {
        key: L.value.id,
      ...
      e("dialog", {
        ...
        o.value ? (t(), l("p", Ka, b(o.value), 1)) : h("", !0),
        I.value === "add" ? (t(), l(q, { key: 1 }, [
          e("label", Na, [M(x, { name: "search" }), Z(e("input", {
            "onUpdate:modelValue": s[5] || (s[5] = (m) => w.value = m),
            placeholder: "查找已知人物",
            "aria-label": "查找已知人物"
          }, null, 512), [[Y, w.value]])]),
          e("div", Ra, [(t(!0), l(q, null, ae(re.value, (m) => (t(), l("button", {
            key: m.name,
            disabled: D.value,
            onClick: (A) => me(m.name)
          }, [
            ...
            e("span", null, [V(b(m.name), 1), m.aliases.length ? (t(), l("small", Ya, b(m.aliases.join("、")), 1)) : h("", !0)]),
            M(x, { name: "plus" })
