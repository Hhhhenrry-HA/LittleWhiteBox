/* eslint-disable */
import { B as J, C as ye, D as Oe, E, F as Fe, H as u, I as h, M as Ke, N as z, R as ce, T as i, _ as c, a as Q, c as me, d as e, f as D, g as b, l as C, m as d, p as g, u as B, v as M, x as ze, z as L } from "./xiaobai-os-runtime-dom.esm-bundler-DwdCK5Jt.js";
var Qe = {
  class: "tasks-icon",
  viewBox: "0 0 24 24",
  fill: "none",
...
var Ye = { class: "tasks-page tasks-detail-page" }, _e = {
  ...
  setup(t) {
    ...
    return (a, s) => (i(), d("section", Ye, [t.loading ? (i(), d("div", _e, [c(y, {
      ...
      e("article", et, [
        ...
        e("div", lt, [e("span", null, [s[3] || (s[3] = b("委托报酬", -1)), e("strong", null, [s[2] || (s[2] = e("small", null, "¤", -1)), b(" " + u(L(V)(t.detail.task.reward)), 1)])]), e("span", nt, [c(y, { name: "ticket" }), b(u(t.detail.task.source === "received" ? "终端委托" : "我的委托"), 1)])]),
        e("div", it, [
      ...
      e("section", bt, [s[12] || (s[12] = e("h3", null, "一路走来", -1)), e("ol", null, [(i(!0), d(C, null, E(t.detail.timeline, (m) => (i(), d("li", { key: m.eventId }, [s[11] || (s[11] = e("i", null, null, -1)), e("div", null, [e("small", null, u(o(m.createdAt)), 1), e("p", null, u(m.summary), 1)])]))), 128))])])
  ...
  role: "status"
}, Mt = { class: "tasks-hint" }, xt = {
  key: 0,
  class: "tasks-hint"
}, St = ["disabled"], At = /* @__PURE__ */ M({
...
}), Dt = At, qt = { class: "tasks-record-top" }, Lt = ["data-status"], Pt = { class: "tasks-reward" }, Nt = { class: "tasks-record-title" }, Vt = { class: "tasks-record-summary" }, Et = { class: "tasks-record-foot" }, jt = /* @__PURE__ */ M({
  ...
  setup(t) {
    return (o, a) => (i(), d("button", {
      ...
      }, [a[1] || (a[1] = e("i", null, null, -1)), b(u(L(fe)[t.task.status]), 1)], 8, Lt), e("span", Pt, [a[2] || (a[2] = e("small", null, "¤", -1)), b(" " + u(L(V)(t.task.reward)), 1)])]),
      e("strong", Nt, u(t.task.title), 1),
      e("span", Vt, u(t.task.resultSummary || t.task.progressSummary || (t.task.status === "recruiting" ? "委托已发布，等待你选择执行者。" : "任务已开始，等待新的进展。")), 1),
      e("span", Et, [e("span", null, [c(y, { name: t.task.source === "received" ? "pin" : "people" }, null, 8, ["name"]), b(u(t.task.source === "received" ? t.task.location : t.task.assignee?.displayName || `${t.task.candidates.length} 位候选人`), 1)]), c(y, { name: "next" })])
    ]));
  }
}), se = jt, Ht = { class: "tasks-page" }, Ut = {
  key: 0,
  class: "tasks-empty"
}, Zt = { class: "tasks-empty-mark" }, Ot = {
  key: 1,
  ...
  setup(t) {
    return (o, a) => (i(), d("section", Ht, [a[3] || (a[3] = e("header", { class: "tasks-page-heading" }, [
      e("span", { class: "tasks-eyebrow" }, "由你执行"),
      e("h2", null, "每一步，都算数。"),
      e("p", null, "在故事中行动，在这里查看已确认的进展。")
    ], -1)), t.records.length ? (i(), d("div", Ot, [(i(!0), d(C, null, E(t.records, (s) => (i(), D(se, {
      key: s.taskId,
      task: s,
      onOpen: (m) => o.$emit("detail", s.taskId)
    }, null, 8, ["task", "onOpen"]))), 128))])) : (i(), d("div", Ut, [
  ...
  setup(t) {
    ...
    return (s, m) => (i(), d("section", ga, [
      ...
      a.value.length ? (i(), d("div", Ca, [(i(!0), d(C, null, E(a.value, (p) => (i(), D(se, {
        key: p.taskId,
        task: p,
...
}), Ra = Ta, Ba = { class: "tasks-page" }, Ma = { class: "tasks-publish-invite" }, xa = { class: "tasks-invite-mark" }, Sa = ["disabled"], Aa = {
  key: 0,
  class: "tasks-hint"
  ...
  setup(t) {
    return (o, a) => (i(), d("section", Ba, [
      e("div", Ma, [
        ...
        }, [c(y, { name: "plus" }), a[2] || (a[2] = b("发布一份委托", -1))], 8, Sa)
      ]),
      ...
      t.records.length ? (i(), d("div", La, [(i(!0), d(C, null, E(t.records, (s) => (i(), D(se, {
        key: s.taskId,
        task: s,
...
}), Na = Pa, Va = { class: "tasks-page tasks-settings-page" }, Ea = { class: "tasks-setting-card" }, ja = { class: "tasks-setting-row" }, Ha = { class: "tasks-setting-icon" }, Ua = { class: "tasks-switch" }, Za = ["checked", "disabled"], Oa = { class: "tasks-setting-card" }, Fa = { class: "tasks-setting-row" }, Ka = { class: "tasks-setting-icon" }, za = ["disabled"], Qa = {
  key: 0,
  class: "tasks-hint"
}, Ga = {
  key: 0,
...
var Ya = { class: "tasks-page" }, _a = { class: "tasks-contract-sheet" }, es = { class: "tasks-contract-heading" }, ts = { class: "tasks-grade" }, as = { class: "tasks-eyebrow" }, ss = { class: "tasks-contract-reward" }, ls = { class: "tasks-seal" }, ns = { class: "tasks-facts" }, is = { key: 0 }, rs = { class: "is-risk" }, us = { class: "tasks-tags" }, ds = { class: "tasks-action-dock" }, os = {
  ...
  setup(t) {
    return (o, a) => (i(), d("section", Ya, [t.listing ? (i(), d(C, { key: 0 }, [
      e("article", _a, [
        ...
        e("div", ss, [e("span", null, [a[2] || (a[2] = b("完成报酬", -1)), e("strong", null, [a[1] || (a[1] = e("small", null, "¤", -1)), b(" " + u(L(V)(t.listing.reward)), 1)])]), e("span", ls, [c(y, { name: "check" }), a[3] || (a[3] = b("终端出资", -1))])]),
        e("dl", ns, [
        ...
        e("div", us, [(i(!0), d(C, null, E(t.listing.tags, (s) => (i(), d("span", { key: s }, u(s), 1))), 128))])
      ]),
  ...
  emits: ["assign"],
  setup(t) {
    return (o, a) => t.task.candidates.length ? (i(), d("div", ys, [(i(!0), d(C, null, E(t.task.candidates, (s, m) => (i(), d("article", {
      key: s.candidateId,
...
}), Cs = ws, Is = { class: "tasks-page" }, Ts = { class: "tasks-recruit-heading" }, Rs = { class: "tasks-reward" }, Bs = { class: "tasks-section-heading" }, Ms = ["disabled"], xs = {
  key: 0,
  class: "tasks-hint",
  role: "status"
}, Ss = {
  ...
  setup(t) {
    return (o, a) => (i(), d("section", Is, [t.task ? (i(), d(C, { key: 0 }, [e("header", Ts, [
      ...
      e("div", null, [e("strong", Rs, "¤ " + u(L(V)(t.task.reward)), 1), e("button", {
        type: "button",
        class: "tasks-text-button",
      ...
      t.recruiting ? (i(), d("p", xs, "正在寻找愿意接下委托的人。你可以离开页面，招募会在后台继续。")) : g("", !0),
      t.disabledReason || t.generationDisabledReason ? (i(), d("p", Ss, u(t.disabledReason || t.generationDisabledReason), 1)) : g("", !0),
      c(Cs, {
        task: t.task,
...
}), Ns = Ps, Vs = ["aria-label"], Es = { class: "tasks-dialog-mark" }, js = { id: "tasks-confirm-title" }, Hs = { class: "tasks-dialog-copy" }, Us = {
  key: 0,
  ...
  setup(t, { emit: o }) {
    ...
    return (p, r) => (i(), d("dialog", {
      ...
      e("span", Es, [c(y, { name: "ticket" })]),
      e("h2", js, u(t.title), 1),
      e("div", Hs, [Oe(p.$slots, "default")]),
      t.error ? (i(), d("p", Us, u(t.error), 1)) : g("", !0),
      t.disabledReason && !t.busy ? (i(), d("p", Zs, u(t.disabledReason), 1)) : g("", !0),
  ...
  setup(t) {
    ...
    const r = h(s(o.initialState)), v = h("board"), j = h("board"), W = h(null), $ = h(null), Z = h(null), le = h(""), _ = h("all"), ee = h(null), ne = B(() => Xe(r.value)), te = B(() => ne.value.received), ie = B(() => ne.value.published), ge = B(() => [...ie.value, ...r.value.history.items].find((l) => l.taskId === le.value) ?? null), $e = B(() => r.value.board?.boardId === Z.value?.boardId ? r.value.board?.listings.find((l) => l.listingId === Z.value?.listingId) ?? null : null), O = B(() => [
      "board",
      "active",
      "published",
      "history"
    ...
    let F = 0;
    const re = B(() => r.value.generation.state === "running" && r.value.generation.kind === "board"), ue = B(() => r.value.generation.state === "running" && r.value.generation.kind === "candidates" ? r.value.generation.taskId ?? "" : ""), x = h(!1), X = h(!1), I = h(!1), ae = h(!1), Y = h(!1), f = h(""), H = h("");
    let T = 0, S = !1, de = () => {
    };
    const oe = B(() => r.value.status === "unconfirmed"), P = B(() => x.value ? "正在处理上一项任务操作" : r.value.status === "loading" ? "任务数据正在准备" : r.value.status === "saving" ? "任务与资金正在保存" : r.value.status === "unconfirmed" ? "请先核实上一次保存结果" : r.value.status === "conflict" ? "请先采用服务端数据" : r.value.status === "blocked" ? r.value.message || "任务暂时不可用" : r.value.generationActive ? "正在生成内容，请稍后" : ""), K = B(() => P.value || (r.value.maintenance.state === "running" ? "正在更新任务" : "")), he = B(() => r.value.maintenance.message);
    function ve(l) {
    ...
    async function Re(l, n) {
      ...
      try {
        N(await A("tasks/candidates/assign", {
          ...
          expectedEventId: l.eventId,
          candidateId: n
        }), k), $.value = null, U("执行者已确认，任务进入进行中。"), S && w("published");
      } catch (R) {
        f.value = q(R);
      } finally {
        x.value = !1;
    ...
    async function Be(l) {
      ...
      try {
        N(await A("tasks/cancel", {
          ...
          expectedTaskRevision: l.taskRevision,
          expectedEventId: l.eventId
        }), n), $.value = null, U("任务已撤回，托管报酬已退回钱包。"), S && w("published");
      } catch (k) {
        f.value = q(k);
      } finally {
        x.value = !1;
    ...
    async function xe() {
      ...
      const n = T;
      try {
        N(await A("tasks/publish", { form: ce(l) }), n), $.value = null, w("published"), U("任务已发布，报酬已锁入托管。");
      } catch (k) {
        f.value = q(k);
      } finally {
        x.value = !1;
    ...
    return ye(() => {
      ...
      e("header", Qs, [
        ...
        e("div", Js, [n[12] || (n[12] = e("small", null, "可用余额", -1)), e("strong", null, "¤ " + u(L(V)(r.value.playerBalance)), 1)]),
        O.value ? (i(), d("button", {
          key: 2,
          type: "button",
          class: "tasks-icon-button",
      ...
      e("div", Ws, [r.value.message || f.value && !$.value || H.value ? (i(), d("aside", {
        key: 0,
        ...
        role: "status"
      }, [e("div", null, [e("p", null, u(r.value.message || ($.value ? "" : f.value) || H.value), 1), oe.value ? (i(), d("button", {
        key: 0,
        type: "button",
        disabled: I.value,
        onClick: qe
      ...
      e("div", {
      ...
      }, null, 8, ["records"])) : v.value === "published" ? (i(), D(Na, {
        key: 2,
        records: ie.value,
        ...
        busy: x.value,
        "disabled-reason": P.value,
        onAccept: n[7] || (n[7] = (k) => Z.value && Ie(Z.value.boardId, Z.value.listingId))
      }, null, 8, [
        "listing",
        "busy",
        "disabled-reason"
      ])) : v.value === "recruit" ? (i(), D(Ns, {
        key: 7,
        task: ge.value,
        busy: x.value,
        recruiting: !!ue.value,
