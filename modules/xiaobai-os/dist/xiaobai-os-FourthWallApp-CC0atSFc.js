/* eslint-disable */
import { A as I, B as Q, E as Be, G as ee, H as ce, J as Xe, K as He, L as se, M as Re, O as Fe, T as Me, U as G, Y as V, b as te, f as re, g as H, h as K, i as ie, l as Qe, m as ne, o as ae, p as v, q as ke, u as le, v as x, x as ge, y as we, z as ye } from "./xiaobai-os-runtime-dom.esm-bundler-ASdQr4iS.js";
import { n as Oe, r as De } from "./xiaobai-os-app-navigation-DrBJz_Kq.js";
import { t as qe } from "./xiaobai-os-AppDialog-CV8GB57a.js";
var Ye = Object.create, Ne = Object.defineProperty, Je = Object.getOwnPropertyDescriptor, xe = Object.getOwnPropertyNames, er = Object.getPrototypeOf, rr = Object.prototype.hasOwnProperty, ar = (u, d) => () => (d || (u((d = { exports: {} }).exports, d), u = null), d.exports), tr = (u, d, l, f) => {
  if (d && typeof d == "object" || typeof d == "function")
    for (var t = xe(d), g = 0, h = t.length, _; g < h; g++)
      _ = t[g], !rr.call(u, _) && _ !== l && Ne(u, _, {
        get: ((p) => d[p]).bind(null, _),
        enumerable: !(f = Je(d, _)) || f.enumerable
      });
  return u;
}, nr = (u, d, l) => (l = u != null ? Ye(er(u)) : {}, tr(d || !u || !u.__esModule ? Ne(l, "default", {
  value: u,
  enumerable: !0
}) : l, u)), sr = 3.35, ir = new TextEncoder();
function ve(u = "") {
  return Math.ceil(ir.encode(String(u || "")).length / sr);
}
var or = { class: "fourth-wall-context" }, lr = ["aria-label", "aria-expanded"], ur = {
  key: 0,
  class: "fourth-wall-context-popover",
  "aria-label": "上下文用量"
}, cr = { class: "fourth-wall-context-total" }, dr = ["disabled"], fr = { key: 2 }, hr = /* @__PURE__ */ te({
  ...
  setup(u, { emit: d }) {
    ...
    return (p, k) => (I(), H("div", or, [v("button", {
      type: "button",
      class: ke(["fourth-wall-context-ring", { "is-warning": u.stats.usedTokens >= u.stats.trigger }]),
      style: Xe({ "--context-fill": `${g.value * 360}deg` }),
      "aria-label": `上下文：约 ${h(u.stats.usedTokens)} / 158k`,
      "aria-expanded": t.value,
      title: "上下文",
      onClick: k[0] || (k[0] = (y) => t.value = !t.value)
    }, [v("span", null, V(u.busy ? "…" : Math.round(g.value * 100)), 1)], 14, lr), t.value ? (I(), H("section", ur, [
      v("header", null, [k[4] || (k[4] = v("strong", null, "上下文", -1)), v("button", {
        type: "button",
        "aria-label": "关闭上下文用量",
        onClick: k[1] || (k[1] = (y) => t.value = !1)
      }, "×")]),
      v("p", cr, "约 " + V(h(u.stats.usedTokens)) + " / 158k", 1),
      v("dl", null, [
      ...
      !u.stats.canSummarize && !u.busy ? (I(), H("small", fr, "暂无可总结的较早聊天，近期原文会保留。")) : K("", !0)
    ])) : K("", !0)]));
  }
}), mr = hr, pr = ["disabled"], gr = ["disabled"], vr = {
  key: 0,
  class: "fourth-wall-dialog-error",
  role: "alert"
}, _r = ["disabled"], wr = ["disabled"], br = /* @__PURE__ */ te({
  ...
  setup(u, { emit: d }) {
    ...
    return (_, p) => (I(), ne(qe, {
      ...
      default: ye(() => [
        ...
        }, null, 8, gr), [[ae, t.value]]),
        u.error ? (I(), H("p", vr, V(u.error), 1)) : K("", !0),
  ...
  (function() {
    ...
    t.helper.matchRecursiveRegExp = function(e, a, r, n) {
      ...
      function C(o) {
        var b = o.match(/^\s*/)[0].length, E = new RegExp("^\\s{0," + b + "}", "gm");
        return o.replace(E, "");
      }
      this._dispatch = function(b, E, T, N) {
        if (i.hasOwnProperty(b)) for (var A = 0; A < i[b].length; ++A) {
          var j = i[b][A](b, E, this, T, N);
          j && typeof j < "u" && (E = j);
        }
        return E;
...
`), o = o.replace(/>[ \t]+</, ">¨NBSP;<"), !b) if (window && window.document) b = window.document;
        ...
        var T = { preList: L(E) };
        w(E);
        for (var N = E.childNodes, A = "", j = 0; j < N.length; j++) A += t.subParser("makeMarkdown.node")(N[j], T);
        function w(Z) {
          for (var X = 0; X < Z.childNodes.length; ++X) {
            var Y = Z.childNodes[X];
            Y.nodeType === 3 ? !/\S/.test(Y.nodeValue) && !/^[ ]+$/.test(Y.nodeValue) ? (Z.removeChild(Y), --X) : (Y.nodeValue = Y.nodeValue.split(`
`).join(" "), Y.nodeValue = Y.nodeValue.replace(/(\s)+/g, "$1")) : Y.nodeType === 1 && w(Y);
          }
        }
        function L(Z) {
          for (var X = Z.querySelectorAll("pre"), Y = [], J = 0; J < X.length; ++J) if (X[J].childElementCount === 1 && X[J].firstChild.tagName.toLowerCase() === "code") {
            var he = X[J].firstChild.innerHTML.trim(), me = X[J].firstChild.getAttribute("data-language") || "";
            if (me === "")
              for (var Ce = X[J].firstChild.className.split(" "), pe = 0; pe < Ce.length; ++pe) {
            ...
            he = t.helper.unescapeHTMLEntities(he), Y.push(he), X[J].outerHTML = '<precode language="' + me + '" precodenum="' + J.toString() + '"></precode>';
          } else
            Y.push(X[J].innerHTML), X[J].innerHTML = "", X[J].setAttribute("prenum", J.toString());
          return Y;
        }
        return A;
        ...
        for (var b = 0; b < o.length; ++b) {
          for (var E = o[b], T = 0; T < r.length; ++T) r[T] === E && r.splice(T, 1);
          for (var N = 0; N < n.length; ++N) n[N] === E && n.splice(N, 1);
        }
    ...
    var F = /([*~_]+|\b)(((https?|ftp|dict):\/\/|www\.)[^'">\s]+?\.[^'">\s]+?)()(\1)?(?=\s|$)(?!["<>])/gi, U = /([*~_]+|\b)(((https?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+?)([.!?,()\[\]])?(\1)?(?=\s|$)(?!["<>])/gi, W = /()<(((https?|ftp|dict):\/\/|www\.)[^'">\s]+)()>()/gi, D = /(^|\s)(?:mailto:)?([A-Za-z0-9!#$%&'*+-/=?^_`{|}~.]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)(?=$|\s)/gim, $ = /<()(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi, R = function(e) {
      "use strict";
    ...
    t.subParser("autoLinks", function(e, a, r) {
      "use strict";
      return e = r.converter._dispatch("autoLinks.before", e, a, r), e = e.replace(W, R(a)), e = e.replace($, O(a, r)), e = r.converter._dispatch("autoLinks.after", e, a, r), e;
    }), t.subParser("simplifiedAutoLinks", function(e, a, r) {
      "use strict";
      return a.simplifiedAutoLink && (e = r.converter._dispatch("simplifiedAutoLinks.before", e, a, r), a.excludeTrailingPunctuationFromURLs ? e = e.replace(U, R(a)) : e = e.replace(F, R(a)), e = e.replace(D, O(a, r)), e = r.converter._dispatch("simplifiedAutoLinks.after", e, a, r)), e;
...
`, c;
      ...
      var n = [
        ...
        var N = o;
        return E.search(/\bmarkdown\b/) !== -1 && (N = E + r.converter.makeHtml(b) + T), `
...
`;
      ...
      e = e.replace(s, function(M, P, S) {
        ...
        var o = t.subParser("spanGamut")(C, a, r), b = a.noHeaderId ? "" : ' id="' + m(S) + '"', E = n - 1 + P.length, T = "<h" + E + b + ">" + o + "</h" + E + ">";
      ...
      function M(S, C, o, b, E, T, N, A) {
        return b = b.replace(/\s/g, ""), P(S, C, o, b, E, T, N, A);
      }
      function P(S, C, o, b, E, T, N, A) {
        var j = r.gUrls, w = r.gTitles, L = r.gDimensions;
        if (o = o.toLowerCase(), A || (A = ""), S.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1) b = "";
        else if (b === "" || b === null)
          if ((o === "" || o === null) && (o = C.toLowerCase().replace(/ ?\n/g, " ")), b = "#" + o, !t.helper.isUndefined(j[o]))
            b = j[o], t.helper.isUndefined(w[o]) || (A = w[o]), t.helper.isUndefined(L[o]) || (E = L[o].width, T = L[o].height);
          else return S;
        ...
        return A && t.helper.isString(A) && (A = A.replace(/"/g, "&quot;").replace(t.helper.regexes.asteriskDashAndColon, t.helper.escapeCharactersCallback), Z += ' title="' + A + '"'), E && T && (E = E === "*" ? "auto" : E, T = T === "*" ? "auto" : T, Z += ' width="' + E + '"', Z += ' height="' + T + '"'), Z += " />", Z;
      }
...
`), s += "¨0";
        var M = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0| {0,3}([*+-]|\d+[.])[ \t]+))/gm, P = /\n[ \t]*\n(?!¨0)/.test(s);
        return a.disableForced4SpacesIndentedSublists && (M = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0|\2([*+-]|\d+[.])[ \t]+))/gm), s = s.replace(M, function(S, C, o, b, E, T, N) {
          N = N && N.trim() !== "";
          var A = t.subParser("outdent")(E, a, r), j = "";
          return T && a.tasklists && (j = ' class="task-list-item" style="list-style-type: none;"', A = A.replace(/^[ \t]*\[(x|X| )?]/m, function() {
...
`), P ? A = t.subParser("paragraphs")(A, a, r) : A = t.subParser("spanGamut")(A, a, r)), A = A.replace("¨A", ""), A = "<li" + j + ">" + A + `</li>
`, A;
      ...
      function c(s, m, M) {
        ...
        if (s.search(C) !== -1) (function E(T) {
          var N = T.search(C), A = i(s, m);
          N !== -1 ? (o += `

<` + m + A + `>
` + n(T.slice(0, N), !!M) + "</" + m + `>
`, m = m === "ul" ? "ol" : "ul", C = m === "ul" ? P : S, E(T.slice(N))) : o += `
...
`);
        ...
        if (b.length < E.length) return S;
        for (C = 0; C < E.length; ++C) A.push(c(E[C]));
...
})), We = /* @__PURE__ */ nr(yr(), 1), Se = /* @__PURE__ */ new Set([
  "script",
  "style",
  "textarea",
  "title"
...
function Ve(u = "", d = 0) {
  ...
  for (; f < l.length; f += 1) {
    ...
    return {
      ...
      name: h,
      closing: t,
      selfClosing: !t && (Sr.has(h) || /\/\s*>$/.test(k))
    };
  }
  return null;
}
...
function $r(u = "", d = 0, l = [], f = []) {
  ...
  for (const [z, B] of _) {
    ...
    y = !0;
    const U = zr(f, z + F);
    if (U.some((D) => D.rawText)) return null;
    const W = new Set(U.filter((D) => D.blockContainer && !D.rawText).map((D) => D.id));
    if (!W.size || (k = k === null ? W : new Set([...k].filter((D) => W.has(D))), !k.size)) return null;
  }
...
`)), f = Ge(l);
  ...
  const t = Ke(d), g = d.map((h, _) => oe(h) ? null : $r(h, t[_], l, f));
...
`)), l = Ge(d);
  ...
  return u.forEach((h, _) => {
    ...
    const p = f[_], k = p + h.length, y = d.filter((D) => D.start >= p && D.end <= k && t.has(D.start));
    let z = 0, B = (h.match(/^[ \t]*/) || [""])[0].length;
    for (const D of y.filter(($) => !$.closing).sort(($, R) => $.start - R.start)) {
      if (D.start - p !== B) break;
      for (z = D.end - p, B = z; /[ \t]/.test(h[B] || ""); ) B += 1;
    }
    let F = h.length;
    B = h.length - (h.match(/[ \t]*$/) || [""])[0].length;
    for (const D of y.filter(($) => $.closing).sort(($, R) => R.end - $.end)) {
      if (D.end - p !== B) break;
      for (F = D.start - p, B = F; B > 0 && /[ \t]/.test(h[B - 1]); ) B -= 1;
    }
    if (!z && F === h.length) {
      g.push(h);
      return;
...
var _e = null, $e = !1, Ee = 0, Lr = /* @__PURE__ */ new Map(), je = 0, be = /* @__PURE__ */ new Map(), Ir = /* @__PURE__ */ new Set([
  "html",
  "htm",
  "xhtml",
  "xml",
...
function Hr() {
  return Ee += 1, `html-${Date.now().toString(36)}-${Ee.toString(36)}`;
}
function Rr() {
  return je += 1, `raw-${Date.now().toString(36)}-${je.toString(36)}`;
}
function Fr(u = "") {
  return Ir.has(String(u || "").trim().toLowerCase());
}
function Or() {
...
function Ae(u = "") {
  ...
  for (let t = 0; t < l.length; t += 1) {
    ...
    for (; t + 1 < l.length && oe(l[t + 1]); )
      t += 1, h.push(l[t]);
    (f[f.length - 1] ?? "").trim() && f.push(""), f.push(Nr(h.join(`
`)));
    const _ = l[t + 1] ?? "";
    _.trim() && !oe(_) && f.push("");
  }
...
function Wr(u = "", d = {}) {
  ...
  let h = "", _ = 0, p = null;
  for (; (p = g.exec(l)) !== null; ) {
    const k = p[1] || "", y = p.index + k.length, z = g.lastIndex, B = String(p[3] || "").trim().split(/\s+/)[0] || "", F = String(p[4] || ""), U = Fr(B) || !B && Dr(F);
    h += t ? Ae(l.slice(_, y)) : l.slice(_, y), U && f !== "code" ? h += qr(F, B || "html") : h += l.slice(y, z), _ = z;
  }
...
function Kr(u = "") {
  const d = Gr(u).trim().replace(/[\u0000-\u001F\u007F\s]+/g, "").toLowerCase();
...
function Jr(u = "", d = de) {
  ...
  return String(u || "").replace(/@import[^;]+;?/gi, "").replace(/(^|[{}])\s*([^@{}][^{}]*)\{/g, (f, t, g) => {
    const h = Xr(g).map((_) => _.trim()).filter(Boolean);
...
function Le(u = "", d = {}) {
  ...
  return String(u || "").replace(/<custom-style>([\s\S]+?)<\/custom-style>/gim, (f, t) => {
    try {
      return `<style>${Jr(decodeURIComponent(String(t || "")).replaceAll(/<br\/>/g, ""), l)}</style>`;
    } catch (g) {
...
function ea(u = "") {
  return String(u || "").replace(/<\/?(?:script|style|iframe|object|embed|link|meta|base|form|input|button|textarea|select|option)[^>]*>/gi, "").replace(/\s+on[a-z0-9_-]+\s*=\s*(?:"[^"]*"|'[^']*'|[^\s"'=<>`]+)/gi, "").replace(/\s+class\s*=\s*("[^"]*"|'[^']*'|[^\s"'=<>`]+)/gi, (d, l) => {
    const f = String(l || "")[0], t = f === '"' || f === "'", g = xr(t ? String(l).slice(1, -1) : String(l || ""));
    return t ? ` class=${f}${g}${f}` : ` class=${g}`;
  }).replace(/\s+(href|src|xlink:href)\s*=\s*("[^"]*"|'[^']*'|[^\s"'=<>`]+)/gi, (d, l, f) => Kr(String(f || "").replace(/^["']|["']$/g, "")) ? "" : ` ${l}=${f}`);
}
function Ie(u) {
...
function ta(u, d = {}) {
  ...
  const f = Wr(l, d);
  try {
    return _e || (Or(), _e = new We.default.Converter({
      emoji: !0,
      literalMidWordUnderscores: !0,
      parseImgDimensions: !0,
      simpleLineBreaks: !0,
      ...
      underline: !0,
      disableForced4SpacesIndentedSublists: !0
    })), Te(aa(Vr(_e.makeHtml(f))));
  } catch {
  }
  return Te(Br(f).replace(/\n/g, "<br>"));
}
...
function Ze(u, d = globalThis.document) {
  ...
  function p(y, z = !1) {
    ...
    const U = Array.from(B.childNodes).flatMap((D) => p(D, z || [
      "code",
      "pre",
      "a"
    ].includes(F)));
    if (!na.has(F)) return U;
    const W = {};
    if (F === "a") {
      const D = h(B.getAttribute("href") || "").trim();
      if (!/^(?:https?:\/\/|mailto:)/i.test(D)) return U;
      W.href = D, W.target = "_blank", W.rel = "noopener noreferrer", B.hasAttribute("title") && (W.title = h(B.getAttribute("title")));
    }
  ...
  return k.innerHTML = ta(t, { htmlFenceMode: "code" }), {
    nodes: Array.from(k.content.childNodes).flatMap((y) => p(y)),
    media: l
  };
}
var ia = ["data-message-index"], oa = ["src"], la = {
  key: 1,
  class: "fourth-wall-avatar is-placeholder",
  "aria-hidden": "true"
}, ua = { class: "fourth-wall-message-stack" }, ca = {
  key: 0,
  class: "fourth-wall-thinking"
}, da = { class: "fourth-wall-bubble" }, fa = ["data-image-index"], ha = ["src", "alt"], ma = ["onClick"], pa = {
  key: 2,
  class: "fourth-wall-image-unavailable"
}, ga = ["disabled", "onClick"], va = ["onClick"], _a = { "aria-hidden": "true" }, wa = { key: 0 }, ba = { class: "fourth-wall-message-actions" }, ka = ["disabled"], ya = ["disabled"], Sa = ["disabled"], Ca = { key: 1 }, Pa = /* @__PURE__ */ te({
    ...
    return Fe(() => {
      y = l.bridge.subscribe((a) => {
        ...
        for (const r of a) {
          ...
          i?.kind === "image" && D(i, n), _?.unobserve(r.target);
        }
      ...
      ref_key: "root",
      ref: h,
      class: ke(["fourth-wall-message", u.message.role === "user" ? "is-user" : "is-ai"]),
      ...
      alt: ""
    }, null, 8, oa)) : (I(), H("span", la)), v("div", ua, [
      u.message.thinking ? (I(), H("details", ca, [r[3] || (r[3] = v("summary", null, "思考过程", -1)), v("div", null, V(u.message.thinking), 1)])) : K("", !0),
      v("div", da, [t.value ? Q((I(), H("textarea", {
        key: 0,
        "onUpdate:modelValue": r[0] || (r[0] = (n) => g.value = n),
        class: "fourth-wall-edit",
        rows: "3"
      }, null, 512)), [[ae, g.value]]) : (I(), ne(He(Ue), {
        key: 1,
        content: z.value
      }, {
        media: ye(({ segment: n, index: i }) => [n.kind === "image" ? (I(), H("span", {
          key: 0,
          ...
          src: p[i].source,
          alt: n.value
        }, null, 8, ha)) : p[i]?.status === "error" ? (I(), H("button", {
          key: 1,
          type: "button",
          onClick: (c) => D(n, i)
        }, [x(V(n.raw), 1), v("small", null, V(p[i].message) + "，点此重试", 1)], 8, ma)) : p[i]?.status === "unavailable" ? (I(), H("span", pa, [x(V(n.raw), 1), v("small", null, V(p[i].message), 1)])) : (I(), H("button", {
          key: 3,
          type: "button",
          disabled: p[i]?.status === "loading",
          onClick: (c) => D(n, i)
        }, [x(V(n.raw), 1), v("small", null, V(p[i]?.message || "生成图片"), 1)], 8, ga))], 8, fa)) : (I(), H("button", {
          key: 1,
          class: "fourth-wall-voice",
          type: "button",
          onClick: (c) => $(n, i)
        }, [
          v("span", _a, V(p[i]?.status === "playing" ? "■" : "▶"), 1),
          v("span", null, V(n.value), 1),
          p[i]?.message ? (I(), H("small", wa, V(p[i].message), 1)) : K("", !0)
        ], 8, va))]),
        _: 1
      }, 8, ["content"])), v("div", ba, [t.value ? (I(), H(le, { key: 0 }, [v("button", {
        type: "button",
        disabled: !u.editable,
        onClick: O
      }, "保存", 8, ka), v("button", {
      ...
      B.value ? (I(), H("time", Ca, V(B.value), 1)) : K("", !0)
    ])], 10, ia));
  }
}), Ma = Pa, za = ["disabled"], $a = {
  key: 1,
  ...
  key: 1,
  class: "fourth-wall-avatar is-placeholder"
}, La = { class: "fourth-wall-message-stack" }, Ia = {
  key: 0,
  class: "fourth-wall-thinking",
  open: ""
}, Ba = { class: "fourth-wall-bubble" }, Ha = {
  key: 2,
  class: "fourth-wall-unsaved"
}, Ra = ["disabled"], Fa = /* @__PURE__ */ te({
  ...
  setup(u, { emit: d }) {
    ...
    function B() {
      const $ = t.value;
      if (!$) return null;
      const R = $.getBoundingClientRect().top, O = Array.from($.querySelectorAll("[data-message-index]")).find((q) => q.getBoundingClientRect().bottom > R);
      return O ? {
        index: O.dataset.messageIndex,
        offset: O.getBoundingClientRect().top - R
      } : null;
    }
    async function F($, R = !1) {
      ...
      if (q) {
        ...
        if (O) {
          const e = q.querySelector('[data-message-index="' + O.index + '"]');
          e && (q.scrollTop += e.getBoundingClientRect().top - q.getBoundingClientRect().top - O.offset);
        }
      }
    }
    function U() {
    ...
    function D($, R) {
      const O = g.value.messages[$ - g.value.start];
      O && (k.value?.index === $ ? k.value.content = R : k.value = {
        index: $,
        content: R,
        original: O.content,
        ts: O.ts,
    ...
    return se(() => l.page, ($) => {
      ...
      g.value.start > 0 ? (I(), H("button", {
        ...
        disabled: _.value,
        onClick: R[0] || (R[0] = (O) => W("earlier"))
      }, V(_.value ? "读取中…" : "查看更早的记录"), 9, za)) : K("", !0),
      g.value.total === 0 && u.generation.status === "idle" ? (I(), H("div", $a, [...R[6] || (R[6] = [
        v("span", null, "IV", -1),
        v("strong", null, "越过故事边界", -1),
        v("p", null, "这里是你与角色扮演者的皮下私聊。", -1)
      ])])) : K("", !0),
      (I(!0), H(le, null, Re(g.value.messages, (O, q) => (I(), ne(Ma, {
        key: O.ts + "-" + (g.value.start + q),
        message: O,
        ...
        bridge: u.bridge,
        editable: !u.busy,
        "edit-draft": k.value?.index === g.value.start + q && k.value.ts === O.ts ? k.value.content : void 0,
        onDraft: (e) => D(g.value.start + q, e),
      ...
      g.value.start + g.value.messages.length < g.value.total ? (I(), H("button", {
        ...
        class: "fourth-wall-earlier",
        disabled: _.value,
        onClick: R[4] || (R[4] = (O) => W("later"))
      }, " 查看后面的记录 ", 8, Ea)) : K("", !0),
      u.generation.status !== "idle" && p.value ? (I(), H("article", ja, [u.characterAvatar ? (I(), H("img", {
        key: 0,
        class: "fourth-wall-avatar",
        src: u.characterAvatar,
        alt: ""
      }, null, 8, Aa)) : (I(), H("span", Ta)), v("div", La, [u.generation.thinking ? (I(), H("details", Ia, [R[7] || (R[7] = v("summary", null, "思考中", -1)), v("div", null, V(u.generation.thinking), 1)])) : K("", !0), v("div", Ba, [u.generation.text ? (I(), ne(He(Ue), {
        key: 0,
        content: h.value
      }, null, 8, ["content"])) : (I(), H(le, { key: 1 }, [x(V(u.generation.status === "error" ? u.generation.message : z[u.generation.phase || "replying"]), 1)], 64)), u.generation.unsaved ? (I(), H("small", Ha, "未保存")) : K("", !0)])])])) : K("", !0),
      p.value ? K("", !0) : (I(), H("button", {
        key: 4,
        type: "button",
        class: "fourth-wall-latest",
        disabled: _.value,
        onClick: R[5] || (R[5] = (O) => W("latest"))
      }, "回到最新 ↓", 8, Ra))
    ], 544));
  }
}), Oa = Fa, Da = {
  ...
  role: "dialog",
  "aria-label": "四次元壁提示词"
}, qa = { class: "fourth-wall-prompt-fields" }, Na = /* @__PURE__ */ te({
...
}), Ua = Na, Wa = { class: "fourth-wall-settings-section" }, Va = { class: "fourth-wall-session-row" }, Ga = ["value", "disabled"], Ka = ["value"], Za = ["disabled"], Xa = ["disabled"], Qa = ["disabled"], Ya = /* @__PURE__ */ te({
  ...
  setup(u, { emit: d }) {
    ...
    return (h, _) => (I(), H("section", Wa, [_[3] || (_[3] = v("h3", null, "聊天记录", -1)), v("div", Va, [
      v("select", {
        value: u.activeSessionId,
        disabled: u.disabled,
        onChange: _[0] || (_[0] = (p) => l("switch", p.target.value))
      }, [(I(!0), H(le, null, Re(u.sessions, (p) => (I(), H("option", {
        key: p.id,
        value: p.id
      }, V(p.name), 9, Ka))), 128))], 40, Ga),
      v("button", {
        type: "button",
        disabled: u.disabled,
        title: "新建记录",
...
}), Ja = Ya, xa = { class: "fourth-wall-settings-scroll" }, et = { class: "fourth-wall-settings-section" }, rt = { class: "is-toggle" }, at = { class: "is-toggle" }, tt = ["disabled"], nt = { class: "fourth-wall-settings-section" }, st = { class: "is-toggle" }, it = { class: "is-toggle" }, ot = { class: "is-toggle" }, lt = { key: 0 }, ut = ["disabled"], ct = { class: "fourth-wall-settings-section is-actions" }, dt = /* @__PURE__ */ te({
  ...
  setup(u, { emit: d }) {
    ...
    return (k, y) => (I(), H("aside", {
      ...
      v("section", et, [
        ...
        v("label", rt, [y[15] || (y[15] = v("span", null, "流式生成", -1)), Q(v("input", {
          "onUpdate:modelValue": y[6] || (y[6] = (z) => t.stream = z),
          type: "checkbox"
        }, null, 512), [[ie, t.stream]])]),
        v("label", at, [y[16] || (y[16] = v("span", null, "禁用 Assistant Prefill", -1)), Q(v("input", {
      ...
      v("section", ct, [v("button", {
        type: "button",
        onClick: y[12] || (y[12] = (z) => f("openPrompts"))
      }, "提示词模板")])
    ])], 512));
  }
}), ft = dt, ht = { class: "fourth-wall-app" }, mt = { class: "fourth-wall-header" }, pt = { class: "fourth-wall-heading" }, gt = { class: "fourth-wall-header-actions" }, vt = ["disabled"], _t = ["disabled"], wt = {
  key: 0,
  class: "fourth-wall-error",
  role: "alert"
}, bt = ["disabled"], kt = { class: "fourth-wall-composer" }, yt = ["disabled"], St = ["disabled"], Ct = ["disabled"], Pt = { class: "fourth-wall-clear-choice" }, Mt = {
  key: 0,
  class: "fourth-wall-dialog-error",
  role: "alert"
}, zt = ["disabled"], $t = ["disabled"], ue = 35e3, Et = /* @__PURE__ */ te({
  ...
  setup(u) {
    ...
    const O = re(() => l.value.chat.sessions.find((j) => j.id === l.value.chat.activeSessionId)), q = re(() => $.value.status === "started" || $.value.status === "progress"), e = re(() => ({
      ...l.value.context,
    ...
    se(() => [f.value, $.value.text], () => {
      D || (D = setTimeout(() => {
        W.value = ve(f.value) + ve($.value.text), D = void 0;
      }, 200));
    }), se(() => O.value.id, () => {
    ...
    function r(j) {
      return structuredClone(j.result);
    }
    async function n(j, w) {
      h.value = !0, _.value = "";
      try {
        return l.value = r(await d.bridge.request(j, w, ue)), !0;
      } catch (L) {
    ...
    async function i() {
      const j = f.value.trim();
      if (!(!j || q.value || h.value)) {
        f.value = "", _.value = "", U.value = !1, $.value = {
          status: "started",
          sessionId: O.value.id,
          text: "",
          thinking: "",
          message: "",
          unsaved: !1
        ...
        try {
          ...
          _.value = `发送请求未确认：${w instanceof Error ? w.message : String(w)}。请核对聊天记录后再发送。原输入：${j}`, $.value.status = "idle";
        }
      }
    }
    async function c() {
      if (!(q.value || h.value)) {
        ...
        try {
          ...
          _.value = j instanceof Error ? j.message : String(j), $.value.status = "idle";
        }
      }
    }
    function s() {
...
未保存的原输入：${j}` : f.value = j);
    ...
    function M(j) {
      j.key !== "Enter" || j.shiftKey || p.value || (j.preventDefault(), q.value ? s() : i());
    }
    function P(j) {
      const w = j < O.value.archivedCount ? `这条消息已经归档；删除原文不会修改记忆，需要遗忘的内容请在记忆中删除。
` : "";
    ...
    async function o(j, w, L) {
      j < O.value.archivedCount && !window.confirm("这条消息已经归档，修改原文不会改写记忆；需要同步更正时请编辑记忆。继续修改？") || await n("fourth-wall/edit-message", {
        ...a(),
        revision: L,
        messageIndex: j,
        content: w
    ...
    async function b(j) {
      if (!(q.value || h.value)) {
        ...
        try {
          await d.bridge.request(`fourth-wall/${j}`, a(), ue);
        } catch (w) {
    ...
    async function E() {
      ...
      h.value = !0, _.value = "";
      const j = a(), w = l.value.history.revision;
      try {
        const L = await d.bridge.request("fourth-wall/read-memory", {
          ...j,
          revision: w
        });
        if (j.sessionId !== O.value.id || j.chatIdentity !== l.value.chatIdentity) return;
    ...
    return Fe(() => {
      R = d.bridge.subscribe((j) => {
        if (j.type === "fourth-wall/state" && (l.value = structuredClone(j.payload.state)), j.type !== "fourth-wall/generation") return;
        const w = j.payload;
        if (!(w.sessionId && w.sessionId !== O.value.id)) {
          ...
          if (w.status === "error") {
            _.value = w.message || "生成失败", U.value = !w.manual && w.kind !== "save" && w.kind !== "input-save", m(w.inputDraft), $.value = w.kind === "save" && (w.draft?.text || w.draft?.thinking) ? {
              status: "error",
              sessionId: w.sessionId || O.value.id,
              text: w.draft?.text || "",
      ...
      v("header", mt, [v("div", pt, [w[23] || (w[23] = v("span", null, "IV", -1)), v("div", null, [w[22] || (w[22] = v("strong", null, "四次元壁", -1)), v("small", null, V(O.value.name), 1)])]), v("div", gt, [
        we(mr, {
          stats: e.value,
          busy: q.value,
          phase: $.value.phase,
        ...
        v("button", {
          ...
          viewBox: "0 0 24 24",
          "aria-hidden": "true"
        }, [v("path", { d: "M12 5c-3-2-7-2-9-1v15c3-1 6-1 9 1m0-15c3-2 7-2 9-1v15c-3-1-6-1-9 1V5Z" })], -1)])], 8, vt),
        v("button", {
          type: "button",
          title: "清空当前记录",
          "aria-label": "清空当前记录",
          ...
          viewBox: "0 0 24 24",
          "aria-hidden": "true"
        }, [v("path", { d: "M4 7h16M9 7V4h6v3m3 0-1 13H7L6 7m4 4v5m4-5v5" })], -1)])], 8, _t),
        v("button", {
          type: "button",
          title: "设置",
      ...
      v("footer", kt, [
        ...
        Q(v("textarea", {
          ...
          onKeydown: M
        }, null, 40, St), [[ae, f.value]]),
        v("button", {
          type: "button",
          class: ke({ "is-stop": q.value }),
          disabled: h.value,
