/* eslint-disable */
import { F as B, L as le, M as se, R as ie, S as Q, T as z, V as l, _, b as oe, c as L, d as T, f as v, g as k, h as g, i as ue, l as A, p as i, s as j, u as e, w as s, z as x } from "./xiaobai-os-runtime-dom.esm-bundler-DmE9neiz.js";
...
var ke = {
  ...
  setup(a, { emit: u }) {
    ...
    return (c, r) => (s(), i("dialog", {
      ...
      a.mode !== "withdraw" ? (s(), i(L, { key: 0 }, [
        e("label", $e, [e("span", null, l(a.mode === "deposit-open" ? "存入金额" : "申购金额"), 1), e("span", we, [r[3] || (r[3] = e("i", null, "¤", -1)), se(e("input", {
  ...
  setup(a) {
    return (u, n) => (s(), i("section", Ue, [
      ...
      e("div", Oe, [(s(!0), i(L, null, z(a.products, (t) => (s(), i("article", {
        key: t.id,
  ...
  setup(a) {
    const u = a, n = B(structuredClone(le(u.initialState))), t = B("vault"), b = B(null), h = B(null), C = B(!1), y = B(!1), S = B(!1), $ = B(""), M = B(""), D = B("");
    let R = null, V = () => {
    }, f = 0;
