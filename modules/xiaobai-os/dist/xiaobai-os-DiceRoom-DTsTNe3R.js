...
var O = ["aria-label"], U = {
  ...
  setup(a) {
    return (c, n) => (i(), r("div", {
      class: "dice-call",
      role: "group",
      "aria-label": a.speaker + "叫" + p(C)(a.bid)
    }, [
      e("h3", null, m(a.speaker) + "叫：" + m(p(C)(a.bid)), 1),
  ...
  emits: ["bid", "challenge"],
  setup(a, { emit: c }) {
    const n = a, b = c, u = T(n.game.legalBids[0]?.count || 1), d = T(n.game.legalBids[0]?.face || 2), t = $(() => n.game.bids.at(-1)), s = $(() => [...new Set(n.game.legalBids.map((f) => f.count))]), o = $(() => M(n.game.legalBids, u.value));
    N(() => n.game.legalBids, () => {
    ...
    return (f, l) => (i(), r("section", J, [
      ...
      a.game.legalActions.includes("bid") ? (i(), r("div", Y, [
        ...
        }, [...l[12] || (l[12] = [h(" 开盅", -1), e("small", null, "不信他有这么多", -1)])], 8, ne)) : E("", !0)])
  ...
  class: "dice-showdown",
  "aria-label": "开盅结果"
}, ce = { class: "dice-reveal-hand" }, be = { class: "game-dice-row" }, ge = { class: "dice-reveal-hand" }, fe = { class: "game-dice-row" }, ye = {
  key: 0,
  class: "dice-verdict"
}, ke = /* @__PURE__ */ A({
  __name: "DiceShowdown",
  ...
  setup(a) {
    const c = a, n = T(!1), b = T(!1), u = [], d = $(() => c.detail.matchingDiceCount >= c.detail.finalBid.count), t = $(() => [...c.detail.dealerDice, ...c.detail.playerDice].filter((o) => o === 1).length);
    function s() {
    ...
    return I(() => {
      ...
      e("div", ce, [g[3] || (g[3] = e("span", null, "对方的骰子", -1)), e("div", be, [(i(!0), r(D, null, B(a.detail.dealerDice, (y, f) => (i(), k(w, {
        key: f,
        value: y,
        delay: f * 45,
        highlight: n.value && p(G)(y, a.detail.finalBid.face)
      }, null, 8, [
        "value",
        "delay",
        "highlight"
  ...
  setup(a) {
    const c = a, n = $(() => c.state.activeGame?.kind === "dice" ? c.state.activeGame : null), b = $(() => c.settlement?.record.detail.kind === "dice" ? c.settlement : null), u = $(() => c.inFlight?.endpoint === "game/dice/challenge");
    return (d, t) => b.value && b.value.record.detail.kind === "dice" ? (i(), k($e, {
      ...
      "disabled-reason": a.disabledReason,
      "other-game": a.state.activeGame ? p(j)(a.state.activeGame.kind).name : "",
      rules: [
