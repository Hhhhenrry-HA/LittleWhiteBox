/* eslint-disable */
import { A as G, F as x, L as V, M as C, P as L, S as H, T as z, V as h, _ as T, b as K, c as F, d as j, f as A, g as Q, h as M, i as q, l as U, p as b, r as P, s as X, u as e, w as m, y as Y, z as J } from "./xiaobai-os-runtime-dom.esm-bundler-DmE9neiz.js";
var Z = ["src"], _ = {
  key: 1,
  ...
  emits: ["edit", "delete"],
  setup(n, { emit: w }) {
    const r = n, c = w, g = x(!1), p = x(""), i = L({}), l = /* @__PURE__ */ new Set();
    let v = () => {
    };
    function a(d) {
    ...
    return H(() => {
      ...
      v(), N();
    }), (d, o) => (m(), b("article", { class: J(["fourth-wall-message", n.message.role === "user" ? "is-user" : "is-ai"]) }, [(n.message.role === "user" ? n.userAvatar : n.characterAvatar) ? (m(), b("img", {
      key: 0,
      ...
      e("div", ae, [g.value ? C((m(), b("textarea", {
        ...
        rows: "3"
      }, null, 512)), [[q, p.value]]) : (m(!0), b(F, { key: 1 }, z(f.value, (u, s) => (m(), b(F, { key: `${u.kind}-${s}` }, [u.kind === "text" ? (m(), b("span", se, h(u.value), 1)) : u.kind === "image" ? (m(), b("figure", le, [i[s]?.status === "ready" ? (m(), b("img", {
        key: 0,
        src: i[s].source,
        alt: u.value
        ...
        type: "button",
        onClick: (t) => $(u, s)
      }, [M(h(u.raw), 1), e("small", null, h(i[s].message) + "，点此重试", 1)], 8, ne)) : i[s]?.status === "unavailable" ? (m(), b("div", oe, [M(h(u.raw), 1), e("small", null, h(i[s].message), 1)])) : (m(), b("div", re, [M(h(u.raw), 1), e("small", null, h(i[s]?.message || "准备图片"), 1)]))])) : (m(), b("button", {
        key: 2,
  ...
  setup(n) {
    ...
    return G(() => w.sessionId, () => {
      ...
      (m(!0), b(F, null, z(p.value, (a, f) => (m(), j(fe, {
        key: `${a.ts}-${g.value + f}`,
        message: a,
      ...
      n.generation.status !== "idle" ? (m(), b("article", pe, [n.characterAvatar ? (m(), b("img", {
        ...
        alt: ""
      }, null, 8, ce)) : (m(), b("span", he)), e("div", we, [n.generation.thinking ? (m(), b("details", ke, [v[3] || (v[3] = e("summary", null, "思考中", -1)), e("div", null, h(n.generation.thinking), 1)])) : A("", !0), e("div", Ie, [M(h(n.generation.text || (n.generation.status === "error" ? n.generation.message : "等待回应...")) + " ", 1), n.generation.unsaved ? (m(), b("small", $e, "未保存")) : A("", !0)])])])) : A("", !0)
    ], 512));
  }
}), Se = Ce, xe = {
  ...
  setup(n, { emit: w }) {
    const r = n, c = w, g = L(structuredClone(V(r.templates)));
    function p() {
      c("save", structuredClone(V(g)));
    }
    return (i, l) => (m(), b("div", {
...
}), Ve = Me, qe = { class: "fourth-wall-settings-section" }, Ee = { class: "fourth-wall-session-row" }, Fe = ["value", "disabled"], Ue = ["value"], Te = ["disabled"], We = ["disabled"], Pe = ["disabled"], Be = /* @__PURE__ */ T({
  ...
  setup(n, { emit: w }) {
    ...
    return (i, l) => (m(), b("section", qe, [l[3] || (l[3] = e("h3", null, "聊天记录", -1)), e("div", Ee, [
      e("select", {
        value: n.activeSessionId,
        disabled: n.disabled,
        onChange: l[0] || (l[0] = (v) => r("switch", v.target.value))
      }, [(m(!0), b(F, null, z(n.sessions, (v) => (m(), b("option", {
        key: v.id,
        value: v.id
  ...
  "aria-label": "四次元壁设置"
}, Re = { class: "fourth-wall-settings-scroll" }, Le = { class: "fourth-wall-settings-section" }, Oe = { class: "is-toggle" }, Ge = { class: "is-toggle" }, je = ["disabled"], ze = { class: "fourth-wall-settings-section" }, He = { class: "is-toggle" }, Ke = { class: "is-toggle" }, Qe = { class: "is-toggle" }, Je = { key: 0 }, Xe = ["disabled"], Ye = { class: "fourth-wall-settings-section is-actions" }, Ze = /* @__PURE__ */ T({
  ...
  setup(n, { emit: w }) {
    const r = n, c = w, g = L(structuredClone(V(r.chat.settings))), p = L(structuredClone(V(r.global)));
    function i() {
      c("updateChat", structuredClone(V(g)));
    }
    function l() {
      c("updateGlobal", {
        image: structuredClone(V(p.image)),
        voice: structuredClone(V(p.voice)),
        commentary: structuredClone(V(p.commentary))
      });
    }
    return (v, a) => (m(), b("aside", Ne, [e("header", null, [a[14] || (a[14] = e("strong", null, "四次元壁设置", -1)), e("button", {
      ...
      e("section", Le, [
        ...
        e("label", Oe, [a[17] || (a[17] = e("span", null, "流式生成", -1)), C(e("input", {
      ...
      e("section", ze, [
        ...
        p.commentary.enabled ? (m(), b("label", Je, [M(" 吐槽概率 " + h(p.commentary.probability) + "% ", 1), C(e("input", {
  ...
  setup(n) {
    const w = n, r = x(structuredClone(V(w.initialState))), c = x(""), g = x(!1), p = x(!1), i = x(!1), l = x(""), v = x(!1), a = x({
      status: "idle",
      sessionId: "",
      text: "",
      thinking: "",
    ...
    return H(() => {
      ...
      e("footer", ot, [C(e("textarea", {
        ...
        onKeydown: N
      }, null, 40, rt), [[q, c.value]]), e("button", {
        type: "button",
        class: J({ "is-stop": S.value }),
        disabled: i.value,
