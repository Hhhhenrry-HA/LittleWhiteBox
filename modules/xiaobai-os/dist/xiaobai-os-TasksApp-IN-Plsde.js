/* eslint-disable */
import { E as Ze, F as h, L as ce, M as K, P as He, R as q, S as ye, T as N, V as u, _ as B, b as Fe, c as C, d as x, f, g as c, h as b, i as z, j as Ke, l as R, p as d, s as me, u as e, w as n, z as G } from "./xiaobai-os-runtime-dom.esm-bundler-DmE9neiz.js";
var ze = {
  class: "tasks-icon",
  viewBox: "0 0 24 24",
  fill: "none",
...
var Xe = { class: "tasks-page tasks-detail-page" }, Ye = {
  ...
  setup(t) {
    ...
    return (s, a) => (n(), d("section", Xe, [t.loading ? (n(), d("div", Ye, [c(y, {
      ...
      e("article", _e, [
        ...
        e("div", at, [e("span", null, [a[3] || (a[3] = b("委托报酬", -1)), e("strong", null, [a[2] || (a[2] = e("small", null, "¤", -1)), b(" " + u(q(E)(t.detail.task.reward)), 1)])]), e("span", lt, [c(y, { name: "ticket" }), b(u(t.detail.task.source === "received" ? "终端委托" : "我的委托"), 1)])]),
        e("div", nt, [
      ...
      e("section", kt, [a[12] || (a[12] = e("h3", null, "一路走来", -1)), e("ol", null, [(n(!0), d(C, null, N(t.detail.timeline, (m) => (n(), d("li", { key: m.eventId }, [a[11] || (a[11] = e("i", null, null, -1)), e("div", null, [e("small", null, u(o(m.createdAt)), 1), e("p", null, u(m.summary), 1)])]))), 128))])])
    ...
    return ($, r) => (n(), d("section", mt, [r[17] || (r[17] = e("header", { class: "tasks-page-heading" }, [
      ...
      e("fieldset", { disabled: t.busy }, [
        ...
        e("div", ht, [
          ...
          e("p", null, [r[14] || (r[14] = b("可用余额 ", -1)), e("strong", null, "¤ " + u(q(E)(t.balance)), 1)]),
...
}), At = xt, Dt = { class: "tasks-record-top" }, qt = ["data-status"], Lt = { class: "tasks-reward" }, Pt = { class: "tasks-record-title" }, Vt = { class: "tasks-record-summary" }, Et = { class: "tasks-record-foot" }, Nt = /* @__PURE__ */ B({
  ...
  setup(t) {
    return (o, s) => (n(), d("button", {
      ...
      }, [s[1] || (s[1] = e("i", null, null, -1)), b(u(q(fe)[t.task.status]), 1)], 8, qt), e("span", Lt, [s[2] || (s[2] = e("small", null, "¤", -1)), b(" " + u(q(E)(t.task.reward)), 1)])]),
  ...
  setup(t) {
    ...
    ], -1)), t.records.length ? (n(), d("div", Zt, [(n(!0), d(C, null, N(t.records, (a) => (n(), x(ae, {
      key: a.taskId,
      task: a,
  ...
  setup(t) {
    return (o, s) => (n(), d("section", Kt, [
      ...
      !t.board || !t.board.listings.length ? (n(), d("div", _t, [
        ...
        "aria-busy": t.busy
      }, [(n(!0), d(C, null, N(t.board.listings, (a) => (n(), d("button", {
        key: a.listingId,
        type: "button",
  ...
  setup(t) {
    ...
    return (a, m) => (n(), d("section", fs, [
      ...
      s.value.length ? (n(), d("div", ws, [(n(!0), d(C, null, N(s.value, ($) => (n(), x(ae, {
        key: $.taskId,
        task: $,
...
}), Ts = Is, Rs = { class: "tasks-page" }, Bs = { class: "tasks-publish-invite" }, Ms = { class: "tasks-invite-mark" }, Ss = ["disabled"], xs = {
  key: 0,
  class: "tasks-hint"
}, As = { class: "tasks-section-heading" }, Ds = {
  key: 1,
  ...
  setup(t) {
    return (o, s) => (n(), d("section", Rs, [
      ...
      t.disabledReason ? (n(), d("p", xs, u(t.disabledReason), 1)) : f("", !0),
      e("header", As, [e("h3", null, [s[6] || (s[6] = b("我的委托 ", -1)), e("small", null, u(t.records.length), 1)]), e("button", {
        type: "button",
        class: "tasks-text-button",
        onClick: s[1] || (s[1] = (a) => o.$emit("history"))
      }, [s[7] || (s[7] = b("已结束", -1)), c(y, { name: "next" })])]),
      t.records.length ? (n(), d("div", qs, [(n(!0), d(C, null, N(t.records, (a) => (n(), x(ae, {
        key: a.taskId,
        task: a,
...
}), Ps = Ls, Vs = { class: "tasks-page tasks-settings-page" }, Es = { class: "tasks-setting-card" }, Ns = { class: "tasks-setting-row" }, js = { class: "tasks-setting-icon" }, Os = { class: "tasks-switch" }, Us = ["checked", "disabled"], Zs = { class: "tasks-setting-card" }, Hs = { class: "tasks-setting-row" }, Fs = { class: "tasks-setting-icon" }, Ks = ["disabled"], zs = {
  key: 0,
  class: "tasks-hint"
}, Qs = {
  key: 0,
...
var Xs = { class: "tasks-page" }, Ys = { class: "tasks-contract-sheet" }, _s = { class: "tasks-contract-heading" }, ea = { class: "tasks-grade" }, ta = { class: "tasks-eyebrow" }, sa = { class: "tasks-contract-reward" }, aa = { class: "tasks-seal" }, la = { class: "tasks-facts" }, na = { key: 0 }, ia = { class: "is-risk" }, ra = { class: "tasks-tags" }, ua = { class: "tasks-action-dock" }, da = {
  ...
  setup(t) {
    return (o, s) => (n(), d("section", Xs, [t.listing ? (n(), d(C, { key: 0 }, [
      e("article", Ys, [
        ...
        e("div", sa, [e("span", null, [s[2] || (s[2] = b("完成报酬", -1)), e("strong", null, [s[1] || (s[1] = e("small", null, "¤", -1)), b(" " + u(q(E)(t.listing.reward)), 1)])]), e("span", aa, [c(y, { name: "check" }), s[3] || (s[3] = b("终端出资", -1))])]),
        e("dl", la, [
        ...
        e("div", ra, [(n(!0), d(C, null, N(t.listing.tags, (a) => (n(), d("span", { key: a }, u(a), 1))), 128))])
      ]),
  ...
  emits: ["assign"],
  setup(t) {
    return (o, s) => t.task.candidates.length ? (n(), d("div", ca, [(n(!0), d(C, null, N(t.task.candidates, (a, m) => (n(), d("article", {
      key: a.candidateId,
  ...
  key: 1,
  class: "tasks-hint"
}, xa = { class: "tasks-withdraw" }, Aa = ["disabled"], Da = {
  key: 1,
  class: "tasks-empty"
}, qa = {
  key: 1,
  ...
  setup(t) {
    return (o, s) => (n(), d("section", Ca, [t.task ? (n(), d(C, { key: 0 }, [e("header", Ia, [
      ...
      e("div", null, [e("strong", Ta, "¤ " + u(q(E)(t.task.reward)), 1), e("button", {
        type: "button",
        class: "tasks-text-button",
      ...
      e("div", xa, [s[8] || (s[8] = e("p", null, "暂时不需要这份委托了？", -1)), e("button", {
        type: "button",
...
}), Pa = La, Va = ["aria-label"], Ea = { class: "tasks-dialog-mark" }, Na = { id: "tasks-confirm-title" }, ja = { class: "tasks-dialog-copy" }, Oa = {
  key: 0,
  ...
  setup(t, { emit: o }) {
    ...
    return ($, r) => (n(), d("dialog", {
      ...
      e("span", Ea, [c(y, { name: "ticket" })]),
      e("h2", Na, u(t.title), 1),
      e("div", ja, [Ze($.$slots, "default")]),
  ...
  setup(t) {
    ...
    async function Re(l, i) {
      ...
      const k = I;
      try {
        V(await D("tasks/candidates/assign", {
          taskId: l.taskId,
          expectedTaskRevision: l.taskRevision,
          expectedEventId: l.eventId,
          candidateId: i
    ...
    async function Se() {
      ...
      const i = I;
      try {
        V(await D("tasks/publish", { form: ce(l) }), i), g.value = null, w("published"), O("任务已发布，报酬已锁入托管。");
      } catch (k) {
        p.value = A(k);
      } finally {
        M.value = !1;
    ...
    async function xe(l) {
      ...
      const i = I;
      try {
        V(await D("tasks/settings/update", { autoMaintenance: l }), i), O(l ? "已开启任务进展自动更新。" : "已关闭任务进展自动更新。");
      } catch (k) {
        p.value = A(k);
      } finally {
        W.value = !1;
    ...
    async function Ae() {
      ...
      const l = I;
      try {
        V(await D("tasks/maintenance/run"), l);
      } catch (i) {
        p.value = A(i);
      }
    }
    ...
    async function qe() {
      ...
      const l = I;
      try {
        V(await D("tasks/save/confirm"), l), O("保存结果已重新核实。");
      } catch (i) {
        p.value = A(i);
      } finally {
        P.value = !1;
    ...
    async function Le() {
      ...
      const l = I;
      try {
        V(await D("tasks/save/adopt-server"), l), O("已采用服务端数据。");
      } catch (i) {
        p.value = A(i);
      } finally {
        P.value = !1;
    ...
    return ye(() => {
      ...
      e("header", za, [
        ...
        e("div", Ga, [i[12] || (i[12] = e("small", null, "可用余额", -1)), e("strong", null, "¤ " + u(q(E)(r.value.playerBalance)), 1)]),
        Z.value ? (n(), d("button", {
          key: 2,
          type: "button",
          class: "tasks-icon-button",
      ...
      e("div", {
        ...
        "busy",
        "disabled-reason"
      ])) : v.value === "active" ? (n(), x(Ft, {
        key: 1,
        records: te.value,
        onDetail: Q,
        onDiscover: i[4] || (i[4] = (k) => w("board"))
      }, null, 8, ["records"])) : v.value === "published" ? (n(), x(Ps, {
        key: 2,
        records: ie.value,
        ...
        onHistory: Ee
      }, null, 8, ["records", "disabled-reason"])) : v.value === "history" ? (n(), x(Ts, {
        key: 3,
