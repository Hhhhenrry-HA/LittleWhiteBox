/* eslint-disable */
import { B as g, C as $, E as b, H as l, I as C, N as p, T as m, a as f, d as a, g as h, l as y, m as u, p as v, u as c, v as k } from "./xiaobai-os-runtime-dom.esm-bundler-DwdCK5Jt.js";
import { n as x } from "./xiaobai-os-room-catalog-CxUsjTUC.js";
var G = { class: "game-entry-art" }, N = ["src"], B = { class: "game-entry-rules" }, R = {
  ...
  "max",
  "step"
], V = { class: "game-entry-balance" }, w = ["disabled"], I = {
  key: 2,
  ...
  setup(e) {
    ...
    return (d, t) => (m(), u("section", { class: g(["game-entry", "is-" + r.value.tone]) }, [
      a("div", G, [a("img", {
        src: r.value.artwork,
        alt: ""
      }, null, 8, N), a("span", null, l(r.value.category) + " · 小白游艺室", 1)]),
      a("header", null, [a("h2", null, l(r.value.name), 1), a("p", null, l(r.value.tagline), 1)]),
      a("ol", B, [(m(!0), u(y, null, b(e.rules, (s) => (m(), u("li", { key: s }, l(s), 1))), 128))]),
      e.otherGame ? (m(), u("div", R, [a("p", null, "还有一局" + l(e.otherGame) + "没结束，可以先逛逛，玩完再来。", 1), a("button", {
        type: "button",
        class: "game-primary-action",
        onClick: t[0] || (t[0] = (s) => d.$emit("resume"))
      }, "继续那一局")])) : (m(), u("div", T, [
        a("h3", null, l(e.minimum === e.maximum ? "本局入场" : "拿多少筹码上桌？"), 1),
        e.minimum !== e.maximum ? (m(), u("div", E, [(m(!0), u(y, null, b(e.chips, (s) => (m(), u("button", {
          key: s,
          type: "button",
          "aria-pressed": n.value === s,
          onClick: (H) => n.value = s
        }, [a("span", null, l(s), 1)], 8, L))), 128))])) : v("", !0),
        e.minimum !== e.maximum ? (m(), u("label", S, [
        ...
        a("p", V, "可用 " + l(e.balance.toLocaleString("zh-CN")) + " 小白币 · 仅使用虚拟币", 1),
        a("button", {
          type: "button",
          class: "game-primary-action game-start",
          disabled: !!o.value,
          onClick: t[2] || (t[2] = (s) => d.$emit("start", n.value))
        }, " 下注 " + l(n.value || "—") + "，开始玩 ", 9, w),
        o.value ? (m(), u("p", I, l(o.value), 1)) : v("", !0)
      ]))
    ], 2));
  }
  ...
  setup(e, { emit: i }) {
    ...
    return (d, t) => (m(), u("section", {
      ...
      a("strong", D, [h(l(o.value), 1), t[2] || (t[2] = a("small", null, "小白币", -1))]),
