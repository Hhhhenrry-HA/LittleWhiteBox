/* eslint-disable */
import { B as C, C as z, D as L, E, H as r, I as y, M as Z, R as P, T as n, _ as g, c as I, d as e, f as B, g as x, l as T, m as s, p as h, s as X, u as _, v as b, x as Y, z as $ } from "./xiaobai-os-runtime-dom.esm-bundler-DwdCK5Jt.js";
var ee = {
  class: "wallet-icon",
  viewBox: "0 0 24 24",
  fill: "none",
  ...
  "aria-hidden": "true"
}, he = { class: "wallet-ui-notice-copy" }, ge = { key: 0 }, ye = /* @__PURE__ */ b({
  __name: "WalletNotice",
  props: {
    title: {},
    message: { default: "" },
  ...
  setup(t) {
    return (i, a) => (n(), s("aside", {
      ...
      role: "status"
    }, [e("span", pe, [L(i.$slots, "icon", {}, () => [a[0] || (a[0] = x("!", -1))])]), e("div", he, [
  ...
  setup(t) {
    return (i, a) => (n(), s("div", be, [
      i.$slots.icon ? (n(), s("span", _e, [L(i.$slots, "icon")])) : h("", !0),
      e("strong", null, r(t.title), 1),
...
var Ce = {
  ...
  role: "status"
}, Ee = { class: "wallet-ui-list" }, Ie = { class: "wallet-ledger-foot" }, Le = {
  key: 0,
  ...
  setup(t) {
    ...
    return (p, m) => (n(), s("div", null, [
      e("div", Se, [(n(), s(T, null, E(c, (f) => e("button", {
        key: f.id,
        type: "button",
        "aria-pressed": a.value === f.id,
        onClick: (u) => a.value = f.id
      }, r(f.label), 9, Ne)), 64))]),
      a.value === "transfer" ? (n(), s("p", Ve, "系统账户间的划转，不计入你的个人收支。")) : h("", !0),
      t.loading ? (n(), s("div", De, [g(w, {
        name: "refresh",
        class: "is-spinning"
        ...
        }, [e("h3", null, r(f.date), 1), e("ol", Ee, [(n(!0), s(T, null, E(f.transactions, (u) => (n(), B(xe, {
          key: u.id,
          transaction: u,
          onOpen: m[0] || (m[0] = (M) => p.$emit("open", M))
        }, null, 8, ["transaction"]))), 128))])]))), 128)),
        e("div", Ie, [t.error ? (n(), s("p", Le, r(t.error), 1)) : h("", !0), t.hasMore ? (n(), s("button", {
          key: 1,
          type: "button",
          class: "wallet-ui-text-button",
          disabled: t.loadingMore,
          onClick: m[1] || (m[1] = (f) => p.$emit("loadMore"))
        }, [x(r(t.loadingMore ? "正在读取…" : "查看更早的账单"), 1), g(w, { name: "next" })], 8, Ae)) : t.transactions.length ? (n(), s("span", He, "每一笔，都有来处")) : h("", !0)])
      ], 64))
    ]));
  }
  ...
  setup(t) {
    ...
    return (v, l) => (n(), s("dialog", {
      ...
      "aria-label": "账单详情",
      onCancel: l[1] || (l[1] = I((p) => v.$emit("close"), ["prevent"])),
      onKeydown: [l[2] || (l[2] = I(() => {
      }, ["stop"])), l[3] || (l[3] = X(I((p) => a.value?.focus(), ["prevent"]), ["tab"]))]
    }, [
      ...
      e("div", { class: C(["wallet-receipt-hero", `is-${t.transaction.direction}`]) }, [
        e("span", Ze, [g(w, { name: $(O)(t.transaction) }, null, 8, ["name"])]),
        e("h2", null, r(t.transaction.title), 1),
        e("strong", null, [x(r($(F)(t.transaction)), 1), l[5] || (l[5] = e("small", null, "小白币", -1))]),
  ...
  setup(t) {
    ...
    async function Q() {
      ...
      try {
        ...
        a.value.transactions.push(...k.result.transactions.filter((D) => !J.has(D.id))), a.value.nextCursor = k.result.nextCursor, a.value.hasMore = k.result.hasMore;
      } catch {
    ...
    return z(() => {
      f = i.bridge.subscribe((o) => {
        o.type === "wallet/state" && (u += 1, V(o.payload.state)), o.type === "wallet/error" && (l.value = S(o.payload?.message || ""));
      });
    }), Y(() => {
      u += 1, f();
    }), (o, d) => (n(), s("main", Ke, [
