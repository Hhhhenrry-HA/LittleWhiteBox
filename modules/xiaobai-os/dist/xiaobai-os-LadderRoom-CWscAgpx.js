/* eslint-disable */
import { C as m, I as L, L as b, N as c, O as $, R as h, _ as F, c as g, d as p, f as C, l as B, p as v, u as a, w as R, y as O, z as u } from "./xiaobai-os-runtime-dom.esm-bundler-D8PGSboO.js";
import { r as A } from "./xiaobai-os-room-catalog-CAbNmZml.js";
import { n as G, t as T } from "./xiaobai-os-GameResult-B8mW9l99.js";
var S = { class: "ladder-table" }, z = { class: "room-heading" }, I = { class: "ladder-prize" }, w = {
  class: "ladder-stairs",
  "aria-label": "五层阶梯"
}, N = {
  key: 0,
  "aria-hidden": "true"
}, j = { role: "status" }, E = { class: "ladder-next" }, M = { class: "ladder-paths" }, V = ["disabled", "onClick"], D = { "aria-hidden": "true" }, P = ["disabled"], U = /* @__PURE__ */ F({
  __name: "LadderTable",
  props: {
    game: {},
    disabledReason: {},
  ...
  setup(t) {
    ...
    return O(() => clearTimeout(r)), (i, e) => (m(), v("section", S, [
      ...
      a("div", { class: b(["ladder-landscape", {
        ...
        a("div", w, [(m(), v(g, null, R(5, (n) => a("div", {
          key: n,
      ...
      t.settlement && !d.value ? (m(), p(T, {
        ...
        a("div", M, [(m(!0), v(g, null, R(l.value.nextChoices, (n) => (m(), v("button", {
          key: n.choice,
          type: "button",
          class: b("is-" + n.choice),
          disabled: k.value,
