/* eslint-disable */
import { A as $, B as z, C as T, F as R, R as u, S as U, T as h, V as f, _ as y, c as m, d as A, f as w, p as l, u as i, w as c, z as D } from "./xiaobai-os-runtime-dom.esm-bundler-DmE9neiz.js";
var Y = {
  1: [[2, 2]],
  2: [[1, 1], [3, 3]],
  3: [
...
var V = ["aria-label"], F = { class: "game-die-stage" }, N = { class: "game-die-pips" }, Q = /* @__PURE__ */ y({
  __name: "Die",
  props: {
    value: {},
    delay: { default: 0 },
  ...
  setup(e) {
    ...
    }, [i("div", N, [(c(!0), l(m, null, h(u(Y)[d.face], ([k, x], C) => (c(), l("i", {
      key: C,
      class: "game-die-pip",
...
var X = {
  ...
  setup(e) {
    return (t, a) => e.detail.kind === "dice" ? (c(), l("div", X, [
      ...
      i("div", j, [(c(!0), l(m, null, h(e.detail.dealerDice, (s, r) => (c(), A(E, {
        key: r,
        value: s,
        animate: !1,
        highlight: u(S)(s, e.detail.finalBid.face)
...
var le = [
  {
    ...
    load: () => import("./xiaobai-os-DiceRoom-_L14Wq2_.js")
  },
  {
    ..._("push"),
    record: ee,
    ...
    load: () => import("./xiaobai-os-PushRoom-B_7i-bSS.js")
  },
  {
    ..._("ladder"),
    record: re,
    ...
    load: () => import("./xiaobai-os-LadderRoom-CjXpwIXh.js")
  }
];
function ne(e) {
