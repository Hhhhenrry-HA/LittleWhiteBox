/* eslint-disable */
import { F as xe, L as lt, M as Dt, P as Bt, S as jt, V as we, _ as Ft, a as Kt, b as zt, f as Ht, l as qe, p as Ie, u as w, w as _e, y as Gt, z as Jt } from "./xiaobai-os-runtime-dom.esm-bundler-DmE9neiz.js";
...
function da(t = {}) {
  ...
  function X(e, r) {
    ...
    return {
      ...
      delegateTemperature: L(S.temperature, 1),
      delegateMaxTokens: N(S.maxTokens),
      delegateSendTemperature: Le(S),
  ...
  function We(e) {
    ...
    at && (at.value = String(N(r.delegateMaxTokens))), it && (it.value = String(L(r.delegateTemperature, 1))), ot && (ot.checked = !!(r.delegateSendTemperature ?? !0)), st && (st.style.display = ie(c) ? "" : "none"), Oe && (j(Oe, pt), Oe.value = r.delegateToolMode || "native"), B(e, "delegate"), Ne && (j(Ne, x.map((W) => ({
      value: W,
      label: W
    })), "手动填写"), Ne.value = x.includes(r.delegateModel) ? r.delegateModel : ""), Je(e, "#xb-assistant-model-pull-status", U(a)), Je(e, "#xb-assistant-delegate-model-pull-status", U(c, "delegate")), z(e);
  }
  function It(e) {
...
}, Sa = { "aria-live": "polite" }, xa = ["disabled"], ft = 13e4, ha = /* @__PURE__ */ Ft({
  __name: "AgentApiApp",
  props: {
    bridge: {},
    initialState: {}
  ...
  setup(t) {
    ...
    return jt(() => {
      ...
      Dt(w("section", ya, [w("div", {
        ref_key: "panelRoot",
        ref: o
      }, null, 512), w("div", { class: Jt(["agent-api-connection", `is-${d.value}`]) }, [w("p", Sa, we(u.value), 1), w("button", {
        type: "button",
        disabled: !U.value || R.value,
        onClick: f
      }, we(R.value ? "测试中…" : "测试当前连接"), 9, xa)], 2)], 512), [[Kt, U.value]])
    ])])]));
  }
}), ka = ha;
export {
