/* eslint-disable */
import { $ as Q, A as D, D as se, M as Ce, N as F, Q as L, S as T, T as z, _ as De, a as _, b as X, c as G, et as n, f as Ge, l as r, m as x, o as e, r as E, s as O, x as i, y as ee } from "./xiaobai-os-runtime-core.esm-bundler-Dmqi2Zbl.js";
import { a as ue, c as Ae } from "./xiaobai-os-runtime-dom.esm-bundler-BYy7nd4d.js";
var Be = { class: "game-dialog-card" }, _e = { class: "game-dialog-actions" }, Re = /* @__PURE__ */ x({
  ...
  setup(t) {
    return (A, s) => (i(), r("dialog", {
      open: "",
      class: "game-dialog",
      onCancel: s[2] || (s[2] = Ae((l) => A.$emit("cancel"), ["prevent"]))
    }, [e("section", Be, [
  ...
  setup(t) {
    ...
    return (s, l) => (i(), r("section", Se, [l[2] || (l[2] = e("header", { class: "game-table-heading game-reveal-heading" }, [e("div", null, [e("span", null, "SHOWDOWN"), e("h2", { id: "game-dice-commit-title" }, "正在开骰")])], -1)), e("div", Le, [
      ...
      e("div", Te, [(i(!0), r(E, null, T(F(A), (c) => (i(), r("i", {
        key: c,
        style: Q({ "--game-commit-delay": `${c % 5 * 55}ms` })
      }, null, 4))), 128))]),
...
var Ne = ["aria-label"], ze = { class: "game-die-stage" }, He = { class: "game-die-pips" }, Ye = /* @__PURE__ */ x({
  ...
  setup(t) {
    ...
    function v() {
      ...
      const [R, C] = l[A.value], S = 360 * (2 + Math.floor(Math.random() * 2)) + 146, $ = 360 * (1 + Math.floor(Math.random() * 2)) + 101;
      y = k.animate([
        {
          transform: c(R - S, C - $),
    ...
    }, [e("div", He, [(i(!0), r(E, null, T(F(re)[C.face], ([S, $], b) => (i(), r("i", {
      key: b,
      class: "game-die-pip",
      style: Q({ gridArea: `${S} / ${$}` })
...
}, Ve = { class: "game-table-heading" }, We = { class: "game-dice-cloth" }, qe = { class: "game-dealer-position" }, Qe = {
  key: 0,
  class: "game-current-bid"
}, Xe = {
  key: 1,
  class: "game-current-bid is-empty"
}, Je = { class: "game-player-hand" }, Ke = { class: "game-dice-row" }, Ze = {
  key: 0,
  ...
  setup(t, { emit: A }) {
    ...
    return ($, b) => (i(), r("section", je, [
      ...
      e("div", We, [
        ...
        ])) : (i(), r("div", Xe, [...b[7] || (b[7] = [e("span", null, "等待首轮叫牌", -1)])])),
        e("div", Je, [
      ...
      t.game.legalActions.includes("bid") ? (i(), r("div", Ze, [e("div", ea, [
        ...
        key: m,
        type: "button",
        class: L(["game-face-chip", { "is-active": m === w.value }]),
  ...
  setup(t, { emit: A }) {
    ...
    const k = _(() => s.detail.matchingDiceCount >= s.detail.finalBid.count), R = _(() => s.detail.challenger === "player" ? "你" : "庄家"), C = _(() => s.detail.finalBid.by === "player" ? "你" : "庄家"), S = _(() => s.record.outcome === "player-win" ? "你赢了" : "你输了"), $ = _(() => `${s.record.net > 0 ? "+" : ""}${s.record.net} 小白币`);
    return ee(() => {
      ...
      e("div", {
        ...
        w("verdict") ? (i(), r("div", {
          ...
          e("div", null, [e("strong", null, n(S.value), 1), e("em", null, n($.value), 1)]),
  ...
  "aria-label": "五层挑战进度"
}, Ra = { key: 0 }, Ma = { key: 1 }, Sa = { class: "game-ladder-purse" }, La = {
  key: 0,
  ...
  setup(t, { emit: A }) {
    ...
    const C = _(() => y.value > 0 && f.value === null), S = _(() => !!s.ending && (f.value !== null || y.value === 0)), $ = _(() => !!s.writeDisabledReason || !!s.ending || y.value > 0 || s.stepping);
    function b(d) {
      return {
    ...
    return X(k), (d, h) => (i(), r("section", Ga, [
      ...
      e("div", Ba, [e("div", _a, [(i(), r(E, null, T(5, (B) => e("div", {
        key: B,
        class: L(["game-ladder-floor", b(B)])
      }, [e("span", null, n(B), 1), t.game.steps[B - 1] && B <= o.value ? (i(), r("small", Ra, " ¤ " + n(t.game.steps[B - 1]?.amountAfterSuccess), 1)) : (i(), r("small", Ma, "第 " + n(B) + " 层", 1))], 2)), 64))]), e("div", Sa, [
        e("span", null, n(w.value ? "当前可收手" : "风险起点"), 1),
        e("strong", null, "¤ " + n(g.value), 1),
        e("small", null, "已完成 " + n(o.value) + " / 5 层", 1)
      ])]),
      t.stepping ? (i(), r("p", La, "正在踏上第 " + n(o.value + 1) + " 层并确认落账…", 1)) : S.value && t.ending ? (i(), r("div", {
        key: 1,
...
}, qa = { class: "game-card is-push" }, Qa = ["disabled", "title"], Xa = {
  key: 0,
  class: "game-card-reason"
}, Ja = { class: "game-card is-ladder" }, Ka = { class: "game-bet-field" }, Za = ["disabled", "title"], el = {
  key: 0,
  class: "game-card-reason"
}, al = /* @__PURE__ */ x({
  __name: "GameLobby",
  ...
  setup(t, { emit: A }) {
    ...
    return (M, v) => (i(), r("section", Na, [v[17] || (v[17] = e("div", { class: "game-lobby-hero" }, [
      ...
      e("article", Ya, [
        ...
        e("label", ja, [v[8] || (v[8] = e("span", null, "下注", -1)), se(e("input", {
      ...
      e("article", Ja, [
        ...
        e("label", Ka, [v[14] || (v[14] = e("span", null, "下注", -1)), se(e("input", {
  ...
  setup(t, { emit: A }) {
    ...
    const C = _(() => s.ending?.outcome === "busted"), S = _(() => !!s.ending && (!C.value || y.value)), $ = _(() => !!s.writeDisabledReason || !!s.ending || s.drawing);
    function b(m) {
    ...
    return X(k), (m, d) => (i(), r("section", tl, [
      ...
      e("div", il, [
        g.value || t.drawing ? (i(), r("div", {
          ...
          key: 0,
          class: L(["game-flip-front", `is-${g.value}`])
      ...
      t.drawing ? (i(), r("p", vl, "正在翻牌并确认落账…")) : S.value && t.ending ? (i(), r("div", {
        key: 1,
        class: L(["game-reveal-outcome", `is-${t.ending.outcomeTone}`])
      }, [
        e("strong", null, n(t.ending.outcomeLabel), 1),
  ...
  setup(t) {
    ...
    return (l, c) => (i(), r("section", pl, [
      ...
      t.records.length ? (i(), r("div", kl, [(i(!0), r(E, null, T(t.records, (o) => (i(), r("article", {
        key: o.id,
        class: L(["game-record", `is-${o.outcomeTone}`])
...
}), Ll = Sl, El = { class: "game-app" }, Tl = { class: "game-header" }, Il = { class: "game-funds" }, Ol = ["disabled"], xl = {
  class: "game-nav",
  "aria-label": "游戏页面"
  ...
  setup(t) {
    const A = /* @__PURE__ */ new Set([
      ...
      "cleared",
      "capped"
    ]), s = t, l = D(structuredClone(Ce(s.initialState))), c = D(l.value.activeGame?.kind || "lobby"), o = D(!1), g = D(!1), w = D(!1), y = D(""), f = D(""), M = D(""), v = D(null), k = D(null), R = D(""), C = D(null), S = D(null), $ = D({
      balance: l.value.balance,
      lockedAmount: l.value.lockedAmount
    });
    let b = () => {
    }, m = 0, d = 0;
    const h = _(() => l.value.status === "unconfirmed" || l.value.status === "save-failed"), B = _(() => g.value ? "正在处理上一项操作" : o.value ? "正在刷新游戏状态" : l.value.status !== "ready" ? l.value.message || "游戏暂时不可写入" : l.value.generationActive ? "主剧情正在生成，请等待回复完成" : ""), J = _(() => o.value || g.value || h.value || l.value.status === "conflict"), N = _(() => l.value.records.find((u) => u.id === R.value) || null), ae = _(() => S.value?.endpoint !== "game/dice/challenge" || l.value.activeGame?.kind !== "dice" ? null : l.value.activeGame.bids.at(-1) || null), oe = _(() => S.value?.endpoint === "game/push/draw"), de = _(() => S.value?.endpoint === "game/ladder/step"), le = _(() => C.value?.kind === "push" ? C.value.game : l.value.activeGame?.kind === "push" ? l.value.activeGame : null), te = _(() => C.value?.kind === "ladder" ? C.value.game : l.value.activeGame?.kind === "ladder" ? l.value.activeGame : null);
    function Y() {
    ...
    async function H(u, a = Y()) {
      if (B.value) return !1;
      const p = m;
      g.value = !0, S.value = u, f.value = "", k.value = null;
      try {
    ...
    return ee(() => {
      ...
      m += 1, b(), v.value = null, k.value = null, S.value = null;
    }), (u, a) => (i(), r("main", El, [
      e("header", Tl, [
      ...
      e("nav", xl, [
        e("button", {
          type: "button",
          class: L({ "is-active": c.value === "lobby" }),
          onClick: a[0] || (a[0] = (p) => P("lobby"))
        }, "大厅", 2),
        l.value.activeGame ? (i(), r("button", {
          key: 0,
          type: "button",
          class: L({ "is-active": c.value === l.value.activeGame.kind }),
          onClick: a[1] || (a[1] = (p) => c.value = l.value.activeGame?.kind || "lobby")
        }, [...a[20] || (a[20] = [Ge(" 当前牌桌", -1), e("i", null, null, -1)])], 2)) : G("", !0),
        e("button", {
          type: "button",
          class: L({ "is-active": c.value === "records" }),
          onClick: a[2] || (a[2] = (p) => P("records"))
        }, "记录", 2)
      ]),
      l.value.message || y.value ? (i(), r("aside", {
        key: 0,
        class: L(["game-notice", `is-${l.value.status}`]),
        role: "status"
      ...
      e("div", zl, [N.value && c.value === "lobby" ? (i(), r("div", {
        key: 0,
        class: L(["game-result-banner", `is-${N.value.outcomeTone}`]),
        role: "status"
      }, [
