/* eslint-disable */
import { B as X, C as n1, E as S, F as f1, H as i, I as L, N as B, R as p1, T as a, V as b1, _ as c, a as o1, b as T1, c as s1, d as t, f as A, g as T, h as H, k as y1, l as C, m as s, o as J, p as b, u as $, v as I, x as k1, z as _ } from "./xiaobai-os-runtime-dom.esm-bundler-DwdCK5Jt.js";
...
}), L1 = _1, C1 = ["id"], S1 = ["id"], I1 = ["id"], H1 = ["fill"], D1 = {
  key: 0,
...
var vt = ["aria-label"], qt = { class: "shop-dialog-heading" }, ht = { class: "shop-eyebrow" }, ct = { class: "shop-dialog-item" }, mt = { key: 0 }, ft = { key: 1 }, pt = {
  ...
  class: "shop-inline-error",
  role: "alert"
}, _t = { class: "shop-dialog-actions" }, Lt = ["disabled"], Ct = ["disabled"], St = /* @__PURE__ */ I({
  ...
  setup(e, { emit: p }) {
    const o = e, q = p, r = L(null), d = f1({}), u = $(() => o.mode === "purchase" ? "把这份奇妙带回去" : o.mode === "use" ? "让奇物进入故事" : "关闭这份效果？"), h = $(() => o.mode !== "use" || o.item.inputs.every((y) => String(d[y.key] || "").trim().length > 0)), l = $(() => !o.busy && !o.disabledReason && h.value);
  ...
  setup(e) {
    ...
    return (d, u) => (a(), s("section", Ht, [
      ...
      o.value.length ? (a(), s("div", Vt, [(a(!0), s(C, null, S(o.value, (h) => (a(), s("article", {
        key: h.id,
  ...
  emits: ["open"],
  setup(e) {
    const p = e, o = L("all"), q = L(""), r = $(() => p.catalog.filter((l) => l.onShelf)), d = $(() => {
...
}, Ze = ["data-category"], $e = { class: "shop-detail-category" }, we = { class: "shop-detail-copy" }, Me = { id: "shop-detail-title" }, xe = { class: "shop-detail-price" }, _e = { class: "shop-detail-description" }, Le = { class: "shop-item-terms" }, Ce = { key: 0 }, Se = { class: "shop-use-guide" }, Ie = { key: 0 }, He = {
  key: 0,
  ...
  setup(e) {
    const p = e, o = L(structuredClone(p1(p.initialState))), q = L("shelf"), r = L(null), d = L(null), u = $(() => o.value.catalog.find((v) => v.id === d.value)), h = $(() => o.value.catalog.reduce((v, n) => v + n.quantity, 0)), l = $(() => o.value.activations.filter((v) => v.state === "active").length), f = L("");
    let m = 0;
    const y = L(null), Z = L(!1), g = L(!1), M = L(""), N = L(""), Q = $(() => o.value.catalog.find((v) => v.id === y.value?.itemId)), Y = $(() => o.value.activations.find((v) => v.activationId === y.value?.activationId));
    let t1 = () => {
    }, x = 0;
    ...
    async function v1() {
      d.value = null, await T1(), r.value?.scrollTo(0, m);
    }
    function q1(v) {
    ...
    return n1(() => {
      ...
      ])) : (a(), s(C, { key: 1 }, [q.value === "shelf" ? B((a(), A(de, {
        key: 0,
