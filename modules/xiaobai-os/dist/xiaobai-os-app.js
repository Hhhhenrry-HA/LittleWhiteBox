/* eslint-disable */
import { B as N, D as t2, E as r2, F as y, I as i2, N as V, R as o2, S as l2, T as s2, V as _, _ as O, b as n2, c as c2, d as $, f as R, g as U, h as d2, j as X, l as K, n as p2, p as f, s as f2, t as u2, u as i, w as d, x as h2, y as v2, z as H } from "./xiaobai-os-runtime-dom.esm-bundler-DmE9neiz.js";
...
var L2 = Object.freeze({
  "agent-api": w(y2, G2, () => import("./xiaobai-os-AgentApiApp-PrQoMoBx.js")),
  "fourth-wall": w(b2, P2, () => import("./xiaobai-os-FourthWallApp-BjG-n6ga.js")),
  wallet: w(_2, U2, () => import("./xiaobai-os-WalletApp-BRolXZ0l.js")),
  shop: w(S2, I2, () => import("./xiaobai-os-ShopApp-LiZZOxft.js")),
  bank: w(w2, B2, () => import("./xiaobai-os-BankApp-tFIcSCqc.js")),
  game: w(x2, D2, () => import("./xiaobai-os-GameApp-DcGXAonX.js")),
  map: w(k2, E2, () => import("./xiaobai-os-MapApp-8F66ZLSl.js")),
  messages: w(A2, M2, () => import("./xiaobai-os-MessagesApp-cET62YAZ.js")),
  tasks: w(O2, $2, () => import("./xiaobai-os-TasksApp-BRAtiKbB.js")),
  world: w(R2, H2, () => import("./xiaobai-os-WorldApp-D0l84nuq.js"))
}), q = Object.freeze(g2.map((t) => {
  const a = L2[t];
  if (!a) throw new Error(`missing_shell_app:${t}`);
  return a;
})), me = Object.freeze(q.map((t) => t.id)), T2 = /* @__PURE__ */ O({
  __name: "AppBoundary",
  emits: ["failed"],
  setup(t, { emit: a }) {
    const r = a;
...
}), z2 = T2, j2 = { class: "xiaobai-os-home" }, Z2 = ["src"], F2 = {
  class: "xiaobai-os-app-grid",
  "aria-label": "应用"
}, V2 = ["onClick"], X2 = {
  class: "xiaobai-os-app-icon",
  "aria-hidden": "true"
}, N2 = ["src"], K2 = { class: "xiaobai-os-app-name" }, q2 = /* @__PURE__ */ O({
  ...
  emits: ["openApp"],
  setup(t) {
    return (a, r) => (d(), f("main", j2, [
      t.characterAvatar ? (d(), f("img", {
        key: 0,
      ...
      i("section", F2, [(d(!0), f(c2, null, s2(t.apps, (o) => (d(), f("button", {
        key: o.id,
        type: "button",
        ...
        height: "64",
        draggable: "false"
      }, null, 8, N2)]), i("span", K2, _(o.name), 1)], 12, V2))), 128))])
    ]));
  }
}), W2 = q2, J2 = ["disabled"], Q2 = {
  key: 0,
  "aria-hidden": "true"
}, Y2 = /* @__PURE__ */ O({
  ...
  setup(t) {
    return (a, r) => (d(), f("nav", {
      ...
      i("button", {
        ...
        viewBox: "0 0 24 24",
        "aria-hidden": "true"
      }, [i("path", { d: "m14.5 6-6 6 6 6" })], -1)])], 8, J2),
      i("button", {
        type: "button",
        ...
        viewBox: "0 0 24 24",
        "aria-hidden": "true"
      }, [i("path", { d: "m4.5 11 7.5-6 7.5 6v8h-5v-5h-5v5h-5z" })], -1)), t.isHome ? (d(), f("i", Q2)) : R("", !0)]),
      i("button", {
        type: "button",
...
}), te = ae, re = { class: "xiaobai-os-device" }, ie = { class: "xiaobai-os-glass" }, oe = {
  key: "failure",
  class: "xiaobai-os-app-failure",
  role: "alert"
}, le = { class: "xiaobai-os-app-failure-actions" }, se = {
  key: "loading",
  ...
  setup(t) {
    ...
    return (o, l) => (d(), f("div", re, [l[9] || (l[9] = i("span", {
      class: "xiaobai-os-side-key",
      "aria-hidden": "true"
    }, null, -1)), i("div", ie, [
      U(te, { "is-home": r.value }, null, 8, ["is-home"]),
      i("div", {
        ...
        default: X(() => [r.value ? (d(), $(W2, {
          key: "home",
          apps: t.apps,
          "character-avatar": t.characterAvatar,
          onOpenApp: l[0] || (l[0] = (m) => o.$emit("openApp", m))
        }, null, 8, ["apps", "character-avatar"])) : t.appFailure ? (d(), f("section", oe, [
          l[7] || (l[7] = i("span", {
          ...
          i("div", le, [t.appFailure.retryable ? (d(), f("button", {
            key: 0,
            type: "button",
        ...
        ])) : t.appLoading ? (d(), f("div", se, [l[8] || (l[8] = i("span", { "aria-hidden": "true" }, null, -1)), d2(" 正在打开" + _(t.activeApp?.name), 1)])) : t.activeApp && t.activeComponent ? (d(), f("div", {
          key: `app:${t.activeApp.id}:${t.appRenderKey}`,
          class: "xiaobai-os-app-route"
        }, [U(z2, { onFailed: l[3] || (l[3] = (m) => o.$emit("renderFailed", m)) }, {
  ...
  __name: "App",
  setup(t) {
    const a = m2(), r = y(null), o = y(!1), l = y("light"), m = y(/* @__PURE__ */ new Set()), C = y(""), p = y(null), x = i2(null), k = y(null), u = y(!1), n = y(null), L = y(0), G = y("");
    let T = null, z = () => {
    }, A = 0, h = null;
    const W = K(() => q.filter((e) => m.value.has(e.id)));
    function j(e) {
      const s = new Set(e.map((b) => String(b.id))), c = p.value && !s.has(p.value.id), g = h && !s.has(h.appId);
      m.value = s, !(!c && !g) && (A += 1, h = null, p.value = null, x.value = null, k.value = null, u.value = !1, n.value = null, a.clearAppSession());
    }
    function J(e) {
      A += 1, h = null, l.value = e.theme === "dark" ? "dark" : "light", j(e.apps || []), C.value = String(e.chat?.characterAvatar || ""), p.value = null, x.value = null, k.value = null, u.value = !1, n.value = null, a.clearAppSession(), o.value = !0;
    }
    function Q(e) {
    ...
    async function I(e) {
      ...
      h = c, p.value = e, x.value = null, k.value = null, u.value = !0, n.value = null, a.clearAppSession(), G.value = "";
    ...
    async function Y() {
      ...
      if (!(!e || !s)) {
        ...
        try {
          await a.request("app/retry", { appId: e.id }), await I(e);
        } catch (c) {
          u.value = !1, n.value = {
            phase: "host",
    ...
    function Z(e) {
      !p.value || u.value || n.value || (e.preventDefault(), B(e.error ?? new Error(e.message || "APP 界面运行失败")));
    }
    function F(e) {
      !p.value || u.value || n.value || (e.preventDefault(), B(e.reason));
    }
    function e2() {
      window.location.reload();
    }
    function D() {
      A += 1, h = null, a.post("app/deactivate", { appId: p.value?.id || "" }), a.clearAppSession(), p.value = null, x.value = null, k.value = null, u.value = !1, n.value = null;
    }
    function E() {
    ...
    return l2(async () => {
      ...
      onKeydown: a2,
      onClick: f2(E, ["self"])
    }, [G.value ? (d(), f("div", de, _(G.value), 1)) : R("", !0), o.value ? (d(), $(ce, {
      key: 2,
      apps: W.value,
      "active-app": p.value,
