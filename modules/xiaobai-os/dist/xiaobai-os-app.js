/* eslint-disable */
import { B as $, C as t2, D as r2, E as i2, H as _, I as y, L as o2, M as F, O as l2, P as X, S as s2, T as d, V as N, _ as I, b as n2, c as c2, d as i, f as H, g as d2, l as p2, m as f, n as f2, p as R, t as u2, u as K, v as O, x as h2, z as v2 } from "./xiaobai-os-runtime-dom.esm-bundler-DwdCK5Jt.js";
...
var T2 = Object.freeze({
  ...
  "fourth-wall": w(b2, I2, () => import("./xiaobai-os-FourthWallApp-CEYFeRmI.js")),
  wallet: w(_2, U2, () => import("./xiaobai-os-WalletApp-D35tA2Lk.js")),
  ...
  return a;
})), ye = Object.freeze(q.map((t) => t.id)), j2 = /* @__PURE__ */ O({
  __name: "AppBoundary",
  emits: ["failed"],
  setup(t, { emit: a }) {
    const r = a;
...
}), Z2 = j2, V2 = { class: "xiaobai-os-home" }, F2 = ["src"], X2 = {
  ...
  setup(t) {
    return (a, r) => (d(), f("main", V2, [
      ...
      i("section", X2, [(d(!0), f(p2, null, i2(t.apps, (o) => (d(), f("button", {
        key: o.id,
        type: "button",
  ...
  setup(t) {
    return (a, r) => (d(), f("nav", {
      class: $(["xiaobai-os-navigation", { "is-home": t.isHome }]),
      "aria-label": "系统导航"
    }, [
      i("button", {
        type: "button",
      ...
      i("button", {
        ...
        viewBox: "0 0 24 24",
        "aria-hidden": "true"
      }, [i("path", { d: "m4.5 11 7.5-6 7.5 6v8h-5v-5h-5v5h-5z" })], -1)), t.isHome ? (d(), f("i", ee)) : R("", !0)]),
      i("button", {
        type: "button",
  ...
  setup(t) {
    return (a, r) => (d(), f("header", {
      class: $(["xiaobai-os-system-bar", { "is-home": t.isHome }]),
      "aria-label": "系统状态"
  ...
  setup(t) {
    ...
    return (o, l) => (d(), f("div", oe, [l[9] || (l[9] = i("span", {
      ...
      I(ie, { "is-home": r.value }, null, 8, ["is-home"]),
      i("div", {
        ...
        default: F(() => [r.value ? (d(), H(Q2, {
          key: "home",
          apps: t.apps,
          "character-avatar": t.characterAvatar,
          onOpenApp: l[0] || (l[0] = (m) => o.$emit("openApp", m))
        }, null, 8, ["apps", "character-avatar"])) : t.appFailure ? (d(), f("section", se, [
          l[7] || (l[7] = i("span", {
          ...
          i("div", ne, [t.appFailure.retryable ? (d(), f("button", {
            key: 0,
            type: "button",
        ...
        ])) : t.appLoading ? (d(), f("div", ce, [l[8] || (l[8] = i("span", { "aria-hidden": "true" }, null, -1)), d2(" 正在打开" + _(t.activeApp?.name), 1)])) : t.activeApp && t.activeComponent ? (d(), f("div", {
          key: `app:${t.activeApp.id}:${t.appRenderKey}`,
          class: "xiaobai-os-app-route"
        }, [I(Z2, { onFailed: l[3] || (l[3] = (m) => o.$emit("renderFailed", m)) }, {
          default: F(() => [(d(), H(l2(t.activeComponent), {
            bridge: t.bridge,
  ...
  __name: "App",
  setup(t) {
    const a = m2(), r = y(null), o = y(!1), l = y("light"), m = y(/* @__PURE__ */ new Set()), L = y(""), p = y(null), x = o2(null), k = y(null), u = y(!1), n = y(null), C = y(0), G = y("");
    let z = null, T = () => {
    }, A = 0, h = null;
    ...
    function J(e) {
      A += 1, h = null, l.value = e.theme === "dark" ? "dark" : "light", j(e.apps || []), L.value = String(e.chat?.characterAvatar || ""), p.value = null, x.value = null, k.value = null, u.value = !1, n.value = null, a.clearAppSession(), o.value = !0;
    }
    function Q(e) {
    ...
    return t2(async () => {
      z = document.activeElement instanceof HTMLElement ? document.activeElement : null, T = a.subscribe(Q), a.start(), window.addEventListener("error", Z), window.addEventListener("unhandledrejection", V), await n2(), r.value?.focus();
    }), h2(() => {
      A += 1, h = null, window.removeEventListener("error", Z), window.removeEventListener("unhandledrejection", V), T(), a.dispose(), z?.focus();
    }), (e, s) => (d(), f("main", {
      ref_key: "root",
      ref: r,
