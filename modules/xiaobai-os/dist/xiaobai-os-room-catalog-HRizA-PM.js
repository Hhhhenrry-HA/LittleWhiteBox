/* eslint-disable */
import { A as c, J as C, K as u, L as U, M as h, O as Y, U as R, Y as f, b as y, g as l, h as w, k as z, m as A, p as i, q as D, u as m } from "./xiaobai-os-runtime-dom.esm-bundler-ASdQr4iS.js";
var O = {
  1: [[2, 2]],
  2: [[1, 1], [3, 3]],
  3: [
...
var X = {
  key: 0,
  class: "dice-record"
}, j = { class: "game-dice-row" }, q = { class: "game-dice-row" }, H = /* @__PURE__ */ y({
  __name: "DiceRecord",
  props: { detail: {} },
  setup(e) {
    return (t, a) => e.detail.kind === "dice" ? (c(), l("div", X, [
      ...
      i("div", q, [(c(!0), l(m, null, h(e.detail.playerDice, (s, r) => (c(), A(E, {
        key: r,
        value: s,
        animate: !1,
        highlight: u(G)(s, e.detail.finalBid.face)
...
var le = [
  {
    ...
    load: () => import("./xiaobai-os-DiceRoom-BkYpMLXJ.js")
  },
  {
    ..._("push"),
    record: ee,
    ...
    load: () => import("./xiaobai-os-PushRoom-KXILvEEQ.js")
  },
  {
    ..._("ladder"),
    record: re,
    ...
    load: () => import("./xiaobai-os-LadderRoom-BX9V6ETx.js")
  }
];
function ne(e) {
