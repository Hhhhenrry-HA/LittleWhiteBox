/* eslint-disable */
import { A as x, D as C, M as q, Q as K, S as H, T as G, _ as z, a as U, c as A, et as h, f as M, g as X, k as O, l as f, m as T, o as e, p as Q, r as F, s as j, x as m, y as J } from "./xiaobai-os-runtime-core.esm-bundler-Dmqi2Zbl.js";
import { a as V, c as Y, r as P } from "./xiaobai-os-runtime-dom.esm-bundler-BYy7nd4d.js";
var Z = ["src"], _ = {
  key: 1,
  ...
  setup(n, { emit: w }) {
    ...
    return J(() => {
      ...
      v(), N();
    }), (d, o) => (m(), f("article", { class: K(["fourth-wall-message", n.message.role === "user" ? "is-user" : "is-ai"]) }, [(n.message.role === "user" ? n.userAvatar : n.characterAvatar) ? (m(), f("img", {
      key: 0,
      ...
      e("div", ae, [g.value ? C((m(), f("textarea", {
        ...
        rows: "3"
      }, null, 512)), [[V, p.value]]) : (m(!0), f(F, { key: 1 }, H(b.value, (u, s) => (m(), f(F, { key: `${u.kind}-${s}` }, [u.kind === "text" ? (m(), f("span", se, h(u.value), 1)) : u.kind === "image" ? (m(), f("figure", le, [i[s]?.status === "ready" ? (m(), f("img", {
        key: 0,
        src: i[s].source,
        alt: u.value
  ...
  setup(n) {
    ...
    return G(() => w.sessionId, () => {
      ...
      (m(!0), f(F, null, H(p.value, (a, b) => (m(), j(be, {
        key: `${a.ts}-${g.value + b}`,
        message: a,
  ...
  setup(n, { emit: w }) {
    ...
    return (i, l) => (m(), f("section", Ve, [l[3] || (l[3] = e("h3", null, "聊天记录", -1)), e("div", Ee, [
      ...
      }, [(m(!0), f(F, null, H(n.sessions, (v) => (m(), f("option", {
        key: v.id,
        value: v.id
