/* eslint-disable */
import { A as m, B as p, M as c, O as $, U as f, Y as i, b as g, f as b, g as r, h as v, o as C, p as a, q as k, u as y, v as h } from "./xiaobai-os-runtime-dom.esm-bundler-ASdQr4iS.js";
import { n as x } from "./xiaobai-os-room-catalog-HRizA-PM.js";
var G = { class: "game-entry-art" }, N = ["src"], B = { class: "game-entry-rules" }, R = {
  ...
  "max",
  "step"
], A = { class: "game-entry-balance" }, M = ["disabled"], T = {
  key: 2,
  ...
  setup(e) {
    ...
    return (o, t) => (m(), r("section", { class: k(["game-entry", "is-" + d.value.tone]) }, [
      ...
      e.otherGame ? (m(), r("div", R, [a("p", null, "还有一局" + i(e.otherGame) + "没结束，可以先逛逛，玩完再来。", 1), a("button", {
        ...
        a("p", A, "可用 " + i(e.balance.toLocaleString("zh-CN")) + " 小白币 · 仅使用虚拟币", 1),
        a("button", {
          type: "button",
        ...
        u.value ? (m(), r("p", T, i(u.value), 1)) : v("", !0)
      ]))
    ], 2));
  }
}), Y = w, D = { class: "game-result-net" }, I = ["disabled"], U = /* @__PURE__ */ g({
  __name: "GameResult",
  props: {
    record: {},
    balanceAfter: {},
