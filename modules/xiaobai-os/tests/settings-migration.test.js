...
function createCurrentSettings(enabled = true) {
    return {
        ...
        apps: {
            ...
            dice: { actionChecksEnabled: false, actionCheckFrequency: 'standard', actionCheckRule: 'd20', encountersEnabled: false, coc7Sheet: null },
...
test('enables a new OS entry without enabling automatic app features', async () => {
    for (const settings of [{}, { xiaobaiOs: {} }, { xiaobaiOs: createDefaultXiaobaiOsSettings() }]) {
        ...
        assert.deepEqual(current.apps.dice, { actionChecksEnabled: false, actionCheckFrequency: 'standard', actionCheckRule: 'd20', encountersEnabled: false, coc7Sheet: null });
